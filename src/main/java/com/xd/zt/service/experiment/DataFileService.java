...
public class DataFileService {
    ...
    public String[] Upload(@RequestParam("dataname") MultipartFile file) {
        /*
        ...
        if(!file.isEmpty()) {
          ...
          /*  String path = ClassUtils.getDefaultClassLoader().getResource("").getPath()+"static/";*/
            ...
            try {
                ...
                FileUpUtil.fileupload(file.getBytes(), path, dataname);
            } catch (IOException e) {
            ...
            String datapath = path + dataname;
            fileInformation[0] = dataname;
            fileInformation[1] = datapath;
