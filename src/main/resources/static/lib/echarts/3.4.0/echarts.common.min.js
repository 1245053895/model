	...
	"object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define
		...
		return function(t) {
				...
				return e.m = t, e.c = i, e.p = "", e(0)
						...
						t.exports = i(2), i(100), i(94), i(104), i(178), i(191), i(215), i(192), i(31), i(206), i(199), i(198), i(197), i(
							181), i(207), i(222)
					}, function(t, e) {
						function i(t) {
							...
							} else if (D[n]) e = t.constructor.from(t);
							else if (!P[n] && !T(t)) {
								e = {};
						...
						function n(t, e, r) {
							...
							for (var o in e)
								if (e.hasOwnProperty(o)) {
									var a = t[o],
										s = e[o];
									!M(s) || !M(a) || _(s) || _(a) || T(s) || T(a) || S(s) || S(a) ? !r && o in t || (t[o] = i(e[o], !0)) : n(a, s,
										r)
								} return t
						}
						...
						function o(t, e, i) {
							...
							this._throttledZrFlush = O.throttle(E.bind(o.flush, o), 17), this._theme = E.clone(e), this._chartsViews = [],
								this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._api = new S(this), this._coordSysMgr =
								new T, R.call(this), this._messageCenter = new r, this._initEvents(), this.resize = E.bind(this.resize, this),
								this._pendingActions = [], B(ot, n), B(nt, n), o.animation.on("frame", this._onframe, this)
						}
						...
						function l(t, e) {
							...
							for (var u, c = [], d = "highlight" === i || "downplay" === i, f = 0; f < l.length; f++) {
								var p = l[f];
								u = n.action(p, this._model), u = u || E.extend({}, p), u.type = r.event || u.type, c.push(u), d ? s(this, a, p,
									"series") : o && s(this, a, p, o.main, o.sub)
							}
							"none" === a || d || o || (this[$] ? (J.prepareAndUpdate.call(this, t), this[$] = !1) : J[a].call(this, t)), u =
								h ? {
									type: r.event || i,
									batch: c
						...
						function d(t, e) {
							for (var i = "component" === t, n = i ? this._componentsViews : this._chartsViews, r = i ? this._componentsMap :
									this._chartsMap, o = this._zr, a = 0; a < n.length; a++) n[a].__alive = !1;
							e[i ? "eachComponent" : "eachSeries"](function(t, a) {
								...
								if (!l) {
									var h = F(a.type),
										u = i ? k.getClass(h.main, h.sub) : L.getClass(h.sub);
									if (!u) return;
						...
						function x(t, e) {
							...
							r && e.group.traverse(function(t) {
									t.isGroup || (t.progressive = r ? Math.floor(i++
										...
										*
										/
										var w = i(10), M = i(125), S = i(93), T = i(23), A = i(126), I = i(13), C = i(16), k = i(59), L = i(28), P =
											i(3), D = i(6), O = i(47), z = i(78), E = i(1), N = i(19), R = i(21), B = i(46), V = E.each, F = I.parseClassType,
											G = 1e3, H = 5e3, W = 1e3, Z = 2e3, q = 3e3, j = 4e3, U = 5e3, X = "__flagInMainProcess", Y =
											"__hasGradientOrPatternBg", $ = "__optionUpdated", Q = /^[a-zA-Z0-9_]+$/; r.prototype.on = n("on"), r.prototype
										.off = n("off"), r.prototype.one = n("one"), E.mixin(r, R);
										var K = o.prototype; K._onframe = function() {
											if (this[$]) {
												var t = this[$].silent;
											...
											}, this), this._model.setOption(t, rt), i ? (this[$] = {
												silent: n
											}, this[X] = !1) : (J.prepareAndUpdate.call(this), this._zr.flush(), this[$] = !1, this[X] = !1, h.call(
												this, n), u.call(this, n))
										}, K.setTheme = function() {
											...
											var o = this.getRenderedCanvas(t).toDataURL("/static/image/" + (t && t.type || "png"));
											...
											if (w.canvasSupported) {
												...
												if (ht[e]) {
													...
													E.each(lt, function(r, u) {
														if (r.group === e) {
															var c = r.getRenderedCanvas(E.clone(t)),
													...
													return V(h, function(t) {
														...
														p.add(e)
													}), p.refreshImmediately(), f.toDataURL("/static/image/" + (t && t.type || "png"))
												}
												return this.getDataURL(t)
											}
										}, K.convertToPixel = E.curry(a, "convertToPixel"), K.convertFromPixel = E.curry(a, "convertFromPixel"), K
										...
										var J = {
											update: function(t) {
												var e = this._model,
													...
													r = this._zr;
												if (e) {
													e.restoreData(), n.create(this._model, this._api), f.call(this, e, i), p.call(this, e), n.update(e, i),
													...
													if (a.isSingleCanvas && a.isSingleCanvas()) r.configLayer(0, {
														...
														o.colorStops || o.image ? (r.configLayer(0, {
															clearColor: o
														}), this[Y] = !0, this._dom.style.background = "transparent") : (this[Y] && r.configLayer(0, {
															clearColor: null
														}), this[Y] = !1, this._dom.style.background = o)
													}
												}
											},
											...
											prepareAndUpdate: function(t) {
												var e = this._model;
												d.call(this, "component", e), d.call(this, "chart", e), this.__lastOnlyGraphic ? (V(this._componentsViews,
													function(i) {
														var n = i.__model;
											...
											if (E.isObject(e) || (e = {
												...
												l.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : e.flush !== !1 && w.browser.weChat && this._throttledZrFlush(),
													h.call(this, e.silent), u.call(this, e.silent)
											}
										}, K.on = n("on"), K.off = n("off"), K.one = n("one");
										var tt = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout",
											"contextmenu"
										...
										var et = [], it = {}, nt = [], rt = [], ot = [], at = {}, st = {}, lt = {}, ht = {}, ut = new Date - 0, ct =
											new Date - 0, dt = "_echarts_instance_", ft = {
												version: "3.4.0",
												dependencies: {
													zrender: "3.3.0"
												}
											...
											E.isDom(t) ? t = ft.getInstanceByDom(t) : "string" == typeof t && (t = lt[t]), t instanceof o && !t.isDisposed() &&
												t.dispose()
											...
											"function" == typeof t && (e = t, t = G), nt.push({
												prio: t,
												func: e
											})
										}, ft.registerAction = function(t, e, i) {
											"function" == typeof e && (i = e, e = "");
											var n = E.isObject(t) ? t.type : [t, t = {
												event: e
											}][0];
											...
											"function" == typeof t && (e = t, t = W), ot.push({
												prio: t,
												func: e,
												isLayout: !0
											})
										}, ft.registerVisual = function(t, e) {
											"function" == typeof t && (e = t, t = q), ot.push({
												prio: t,
												func: e
											})
											...
											E.createCanvas = t
										}, ft.registerVisual(Z, i(139)), ft.registerPreprocessor(i(133)), ft.registerLoading("default", i(124)),
										ft.registerAction({
											type: "highlight",
											event: "highlight",
											update: "highlight"
											...
											event: "downplay",
											update: "downplay"
										}, E.noop), ft.List = i(14), ft.Model = i(11), ft.graphic = i(3), ft.number = i(4), ft.format = i(8), ft.throttle =
										O.throttle, ft.matrix = i(20), ft.vector = i(5), ft.color = i(19), ft.util = {}, V(["map", "each",
											"filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject",
											"isFunction", "extend", "defaults", "clone"
										], function(t) {
											ft.util[t] = E[t]
										}), ft.PRIORITY = {
											PROCESSOR: {
										...
										function g(t, e, i, n, r, o) {
											...
											if (a) {
												...
												"function" == typeof u && (u = u(r, n.getAnimationDelayParams ? n.getAnimationDelayParams(e, r) : null)),
													"function" == typeof l && (l = l(r)), l > 0 ? e.animateTo(i, l, u || 0, h, o) : (e.attr(i), o && o())
											} else e.attr(i), o && o()
										}
										var m = i(1),
											v = i(169),
											...
											w = i(5),
											M = {};
										M.Group = i(34), M.Image = i(49), M.Text = i(76), M.Circle = i(160), M.Sector = i(166), M.Ring = i(165), M
											.Polygon = i(162), M.Polyline = i(163), M.Rect = i(164), M.Line = i(161), M.BezierCurve = i(159), M.Arc =
											i(158), M.CompoundPath = i(153), M.LinearGradient = i(91), M.RadialGradient = i(154), M.BoundingRect = i(
												9), M.extendShape = function(t) {
												return x.extend(t)
												...
												var e = M.subPixelOptimize,
													i = t.shape,
													n = t.style.lineWidth;
												return y(2 * i.x1) === y(2 * i.x2) && (i.x1 = i.x2 = e(i.x1, n, !0)), y(2 * i.y1) === y(2 * i.y2) && (i.y1 =
													i.y2 = e(i.y1, n, !0)), t
												...
												var e = M.subPixelOptimize,
													...
													a = i.width,
													s = i.height;
												return i.x = e(i.x, n, !0), i.y = e(i.y, n, !0), i.width = Math.max(e(r + a, n, !1) - i.x, 0 === a ? 0 :
													1), i.height = Math.max(e(o + s, n, !1) - i.y, 0 === s ? 0 : 1), t
												...
												return o = M.applyTransform(o, e, i), Math.abs(o[0]) > Math.abs(o[1]) ? o[0] > 0 ? "right" : "left" : o[
													1] > 0 ? "bottom" : "top"
										...
										n.linearMap = function(t, e, i, n) {
											...
											return "string" == typeof t ? i(t).match(/%$/) ? parseFloat(t) / 100 * e : parseFloat(t) : null == t ?
												NaN : +t
											...
											var i, r = n.quantity(t),
												o = t / r;
											return i = e ? o < 1.5 ? 1 : o < 2.5 ? 2 : o < 4 ? 3 : o < 7 ? 5 : 10 : o < 1 ? 1 : o < 2 ? 2 : o < 3 ?
												3 : o < 5 ? 5 : 10, i * r
										}, n.reformIntervals = function(t) {
											function e(t, i, n) {
												return t.interval[n] < i.interval[n] || t.interval[n] === i.interval[n] && (t.close[n] - i.close[n] ===
													(n ? -1 : 1) || !n && e(t, i, 1))
											}
											t.sort(function(t, i) {
												return e(t, i, 0) ? -1 : 1
											...
											for (var i = -(1 / 0), n = 1, r = 0; r < t.length;) {
												for (var o = t[r].interval, a = t[r].close, s = 0; s < 2; s++) o[s] <= i && (o[s] = i, a[s] = s ? 1 : 1 -
													n), i = o[s], n = a[s];
										...
										n.length = n.len, n.lengthSquare = n.lenSquare, n.dist = n.distance, n.distSquare = n.distanceSquare, t.exports =
											n
									}, function(t, e, i) {
										function n(t, e) {
										...
										u.normalizeToArray = function(t) {
											...
											}, u.LABEL_OPTIONS = ["position", "offset", "show", "textStyle", "distance", "formatter"], u.getDataItemValue =
											function(t) {
												...
												var i = e && e.type;
												return "ordinal" === i ? t : ("time" !== i || isFinite(t) || null == t || "-" === t || (t = +o.parseDate(
													t)), null == t || "" === t ? NaN : +t)
											}, u.createDataFormatModel = function(t, e) {
												var i = new a;
												return s.mixin(i, u.dataFormatMixin), i.seriesIndex = e.seriesIndex, i.name = e.name || "", i.mainType =
													e.mainType, i.subType = e.subType, i.getData = function() {
														return t
													}, i
											}, u.dataFormatMixin = {
												...
												return l(e, function(t, n) {
													if (h(t)) {
														for (var r = 0; r < i.length; r++)
															if (!i[r].option && null != t.id && i[r].exist.id === t.id + "") return i[r].option = t, void(e[n] =
																null);
														for (var r = 0; r < i.length; r++) {
															var o = i[r].exist;
															if (!(i[r].option || null != o.id && null != t.id || null == t.name || u.isIdInner(t) || u.isIdInner(
																	o) || o.name !== t.name + "")) return i[r].option = t, void(e[n] = null)
														}
													}
												}), l(e, function(t, e) {
													if (h(t)) {
												...
												l(t, function(t, i) {
													...
													var n = t.option;
													s.assert(!n || null == n.id || !e[n.id] || e[n.id] === t, "id duplicates: " + (n && n.id)), n && null !=
														n.id && (e[n.id] = t), !t.keyInfo && (t.keyInfo = {})
												}), l(t, function(t, i) {
													var n = t.exist,
														r = t.option,
														o = t.keyInfo;
												...
												function i(t, e, i) {
													for (var n = 0, r = t.length; n < r; n++)
														for (var o = t[n].seriesId, a = u.normalizeToArray(t[n].dataIndex), s = i && i[o], l = 0, h = a.length; l <
															h; l++) {
															var c = a[l];
										...
										n.prototype = {
											...
											brush: function(t, e) {
												...
												if (i.bind(t, this, e), this.setTransform(t), this.__dirty) {
													...
													l && (this._fillGradient = i.getGradient(t, a, f)), u && (this._strokeGradient = i.getGradient(t, s,
														f))
												}
												l ? t.fillStyle = this._fillGradient : c && (t.fillStyle = h.call(a, t)), u ? t.strokeStyle = this._strokeGradient :
													d && (t.strokeStyle = h.call(s, t));
												var p = i.lineDash,
													g = i.lineDashOffset,
													m = !!t.setLineDash,
													v = this.getGlobalScale();
												n.setScale(v[0], v[1]), this.__dirtyPath || p && !m && r ? (n = this.path.beginPath(t), p && !m && (n.setLineDash(
														p), n.setLineDashOffset(g)), this.buildPath(n, this.shape, !1), this.__dirtyPath = !1) : (t.beginPath(),
														this.path.rebuildPath(t)), o && n.fill(t), p && m && (t.setLineDash(p), t.lineDashOffset = g), r &&
													n.stroke(t), p && m && t.setLineDash([]), this.restoreTransform(t), null != i.text && this.drawRectText(
										...
										a.formatTime = function(t, e) {
											...
											var i = r.parseDate(e),
												...
												l = i.getMinutes(),
												h = i.getSeconds();
											return t = t.replace("MM", u(o)).toLowerCase().replace("yyyy", n).replace("yy", n % 100).replace("dd", u(
												a)).replace("d", a).replace("hh", u(s)).replace("h", s).replace("mm", u(l)).replace("m", l).replace(
												"ss", u(h)).replace("s", h)
										...
										function n(t, e, i, n) {
											i < 0 && (t += i, i = -i), n < 0 && (e += n, n = -n), this.x = t, this.y = e, this.width = i, this.height =
												n
										}
										var r = i(5),
											o = i(20),
										...
										n.prototype = {
											...
											applyTransform: function() {
												...
												return function(r) {
													if (r) {
														t[0] = i[0] = this.x, t[1] = n[1] = this.y, e[0] = n[0] = this.x + this.width, e[1] = i[1] = this.y +
															this.height, a(t, t, r), a(e, e, r), a(i, i, r), a(n, n, r), this.x = s(t[0], e[0], i[0], n[0]),
										...
										function i(t) {
											...
											return n && (i.firefox = !0, i.version = n[1]), r && (i.ie = !0, i.version = r[1]), o && (i.edge = !0, i.version =
												o[1]), a && (i.weChat = !0), {
												browser: i,
												os: e,
												node: !1,
										...
										u.box = n, u.vbox = r.curry(n, "vertical"), u.hbox = r.curry(n, "horizontal"), u.getAvailableSize =
											function(t, e, i) {
												var n = e.width,
													r = e.height,
													o = l(t.x, n),
													...
													h = l(t.x2, n),
													u = l(t.y2, r);
												return (isNaN(o) || isNaN(parseFloat(t.x))) && (o = 0), (isNaN(h) || isNaN(parseFloat(t.x2))) && (h = n),
													(isNaN(a) || isNaN(parseFloat(t.y))) && (a = 0), (isNaN(u) || isNaN(parseFloat(t.y2))) && (u = r), i =
													s.normalizeCssArray(i || 0), {
												...
												var n = e.width,
													...
													g = i[1] + i[3],
													m = t.aspect;
												switch (isNaN(d) && (d = n - u - g - a), isNaN(f) && (f = r - c - p - h), isNaN(d) && isNaN(f) && (m > n /
														r ? d = .8 * n : f = .8 * r), null != m && (isNaN(d) && (d = m * f), isNaN(f) && (f = d / m)), isNaN(a) &&
													(a = n - u - d - g), isNaN(h) && (h = r - c - f - p), t.left || t.right) {
													case "center":
														a = n / 2 - d / 2 - i[3];
														break;
													case "right":
											...
											u = r.extend({
												...
												mergeDefaultAndTheme: function(t, e) {
													var i = this.layoutMode,
														...
														r = e.getTheme();
													o.merge(t, r.get(this.mainType)), o.merge(t, this.getDefaultOption()), i && h.mergeLayoutParam(t, n,
														i)
												},
										...
										}), s.enableSubTypeDefaulter(u), s.enableTopologicalTravel(u, n), o.mixin(u, i(129)), t.exports = u
									}, function(t, e, i) {
										(function(e) {
											function n(t) {
											...
											var o = "undefined",
												...
												v = function(t, e) {
													...
													this.dimensions = n, this._dimensionInfos = i, this.hostModel = e, this.dataType, this.indices = [],
											...
											y.type = "list", y.hasItemOption = !0, y.getDimension = function(t) {
												...
												i || (g.hasItemOption = !1), i = i || function(t, e, i, n) {
													...
													return f.isDataItemOption(t) && (g.hasItemOption = !0), f.converDataValue(r instanceof Array ? r[n] :
														r, s[e])
												};
												...
												if (a) return a;
												if (n) {
													for (var s = 1 / 0, l = -(1 / 0), h = 0, u = this.count(); h < u; h++) o = this.get(t, h, e), i && !i(
														o, t, h) || (o < s && (s = o), o > l && (l = o));
												...
												var a = -1;
												if (o)
													for (var s = Number.MAX_VALUE, l = 0, h = this.count(); l < h; l++) {
												...
												for (var h = 0; h < l.length; h++) {
													var u;
													if (1 === s) u = e.call(r, this.get(t[0], h, i), h);
													else {
												...
												for (var o = r(this, [t]), a = this._storage, s = o._storage, l = this.indices, h = o.indices = [], u = [],
														c = [], d = Math.floor(1 / e), f = s[t], p = this.count(), g = 0; g < a[t].length; g++) s[t][g] = a[
													t][g];
												for (var g = 0; g < p; g += d) {
											...
											y.setItemGraphicEl = function(t, e) {
													...
													e && (e.dataIndex = t, e.dataType = this.dataType, e.seriesIndex = i && i.seriesIndex, "group" === e.type &&
														e.traverse(x, e)), this._graphicEls[t] = e
													...
													return e._storage = this._storage, m(e, this), e.indices = this.indices.slice(), this._extent && (e._extent =
														d.extend({}, this._extent)), e
												}, y.wrapMethod = function(t, e) {
													var i = this[t];
													"function" == typeof i && (this.__wrappedMethods = this.__wrappedMethods || [], this.__wrappedMethods.push(
														t), this[t] = function() {
														var t = i.apply(this, arguments);
														return e.apply(this, [t].concat(d.slice(arguments)))
													})
												}, y.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"], y.CHANGABLE_METHODS = ["filterSelf"],
												t.exports = v
										}).call(e, function() {
											return this
										}())
										...
										s.enableClassExtend = function(t, e) {
											t.$constructor = t, t.extend = function(t) {
												...
												return a.extend(i.prototype, t), i.extend = this.extend, i.superCall = r, i.superApply = o, a.inherits(
													i, this), i.superClass = e, i
											}
											...
											if (t.registerClass = function(t, e) {
													...
													var n = r[t];
													if (n && n[h] && (n = e ? n[e] : null), i && !n) throw new Error(e ? "Component " + t + "." + (e || "") +
										...
										var n = i(1),
											...
											g = s.extend({
												...
												layoutMode: null,
												init: function(t, e, i, n) {
													this.seriesIndex = this.componentIndex, this.mergeDefaultAndTheme(t, i), c(this,
														"dataBeforeProcessed", this.getInitialData(t, i)), this.restoreData()
												},
												mergeDefaultAndTheme: function(t, e) {
													var i = this.layoutMode,
														r = i ? u.getLayoutParams(t) : {};
													n.merge(t, e.getTheme().get(this.subType)), n.merge(t, this.getDefaultOption()), a.defaultEmphasis(t.label,
														a.LABEL_OPTIONS), this.fillDataTextStyle(t.data), i && u.mergeLayoutParam(t, r, i)
												},
												mergeOption: function(t, e) {
												...
												formatTooltip: function(t, e, i) {
													function o(t) {
														...
														return n.each(t, function(t, n) {
															var o, s = a.getDimensionInfo(n),
																l = s && s.type;
															o = "ordinal" === l ? t + "" : "time" === l ? e ? "" : r.formatTime("yyyy/MM/dd hh:mm:ss", t) : p(
																t), o && i.push(o)
														}), i.join(", ")
													}
													var a = d(this, "data"),
														s = this.getRawValue(t),
														l = f(n.isArray(s) ? o(s) : p(s)),
														h = a.getName(t),
													...
													var c =
														...
														f(u) + '"></span>',
														g = this.name;
													return "\0-" === g && (g = ""), e ? c + f(this.name) + " : " + l : (g && f(g) + "<br />") + c + (h ?
														f(h) + " : " + l : l)
												},
												isAnimationEnabled: function() {
													if (h.node) return !1;
										...
										function n(t, e) {
											var i = t + ":" + e;
											if (l[i]) return l[i];
											for (var n = (t + "").split("\n"), r = 0, o = 0, a = n.length; o < a; o++) r = Math.max(p.measureText(n[o],
												e).width, r);
										...
										function a(t, e, i, r, o) {
											if (!e) return "";
											o = o || {}, r = f(r, "...");
											for (var a = f(o.maxIterations, 2), l = f(o.minChar, 0), h = n("国", i), u = n("a", i), c = f(o.placeholder,
													""), d = e = Math.max(0, e - 1), p = 0; p < l && d >= u; p++) d -= u;
											var g = n(r);
											g > d && (r = "", g = 0), d = e - g;
										...
										function u(t, e, i, n, r, a, s, l, h, u, c) {
											var d, f, p, g, m, v = .005,
												y = 1 / 0;
											A[0] = h, A[1] = u;
											for (var _ = 0; _ < 1; _ += .05) I[0] = o(t, i, r, s, _), I[1] = o(e, n, a, l, _), g = x(A, I), g < y &&
												(d = _, y = g);
											y = 1 / 0;
											for (var w = 0; w < 32 && !(v < M); w++) f = d - v, p = d + v, I[0] = o(t, i, r, s, f), I[1] = o(e, n, a,
												l, f), g = x(I, A), f >= 0 && g < y ? (d = f, y = g) : (C[0] = o(t, i, r, s, p), C[1] = o(e, n, a, l, p),
										...
										function s(t, e, i) {
											return i < 0 ? i += 1 : i > 1 && (i -= 1), 6 * i < 1 ? t + (e - t) * i * 6 : 2 * i < 1 ? e : 3 * i < 2 ?
												t + (e - t) * (2 / 3 - i) * 6 : t
										}
											...
											if (t) {
												...
												if (0 === l) e = 0, i = 0;
													...
													var u = ((s - n) / 6 + l / 2) / l,
														c = ((s - r) / 6 + l / 2) / l,
														d = ((s - o) / 6 + l / 2) / l;
													n === s ? e = d - c : r === s ? e = 1 / 3 + u - d : o === s && (e = 2 / 3 + c - u), e < 0 && (e += 1),
														e > 1 && (e -= 1)
												}
												var f = [360 * e, i, h];
										...
										function p(t, e, n) {
											if (e && e.length && t >= 0 && t <= 1) {
												...
												var r = t * (e.length - 1),
													...
													h = e[a],
													u = r - o;
												return n[0] = i(l(s[0], h[0], u)), n[1] = i(l(s[1], h[1], u)), n[2] = i(l(s[2], h[2], u)), n[3] = i(l(s[
													3], h[3], u)), n
											}
										}
										...
										function m(t, e, i, r) {
											if (t = h(t)) return t = c(t), null != e && (t[0] = n(e)), null != i && (t[1] = a(i)), null != r && (t[2] =
												a(r)), y(u(t), "rgba")
										}
											...
											n = {
												...
												rotate: function(t, e, i) {
													var n = e[0],
														...
														h = Math.sin(i),
														u = Math.cos(i);
													return t[0] = n * u + a * h, t[1] = -n * h + a * u, t[2] = r * u + s * h, t[3] = -r * h + u * s, t[4] =
														u * o + h * l, t[5] = u * l - h * o, t
												},
												scale: function(t, e, i) {
													var n = i[0],
														r = i[1];
													return t[0] = e[0] * n, t[1] = e[1] * r, t[2] = e[2] * n, t[3] = e[3] * r, t[4] = e[4] * n, t[5] = e[5] *
														r, t
												},
												invert: function(t, e) {
													var i = e[0],
														...
														s = e[5],
														l = i * a - o * n;
													return l ? (l = 1 / l, t[0] = a * l, t[1] = -o * l, t[2] = -n * l, t[3] = i * l, t[4] = (n * s - a * r) *
														l, t[5] = (o * r - i * s) * l, t) : null
												}
											};
										t.exports = n
									}, function(t, e) {
										...
										h.getScaleExtent = function(t, e) {
											var i, n, r, o = t.scale,
												...
												d = null != u,
												f = o.getExtent();
											return "ordinal" === l ? i = (e.get("data") || []).length : (n = e.get("boundaryGap"), s.isArray(n) || (
													n = [n || 0, n || 0]), n[0] = a.parsePercent(n[0], 1), n[1] = a.parsePercent(n[1], 1), r = f[1] - f[0]),
												null == h && (h = "ordinal" === l ? i ? 0 : NaN : f[0] - n[0] * r), null == u && (u = "ordinal" === l ?
													i ? i - 1 : NaN : f[1] + n[1] * r), "dataMin" === h && (h = f[0]), "dataMax" === u && (u = f[1]), (
													null == h || !isFinite(h)) && (h = NaN), (null == u || !isFinite(u)) && (u = NaN), t.setBlank(s.eqNaN(
													h) || s.eqNaN(u)), e.getNeedCrossZero() && (h > 0 && u > 0 && !c && (h = 0), h < 0 && u < 0 && !d && (
													u = 0)), [h, u]
											...
											for (var h = 0; h < t.length; h += s) {
												...
												c[n ? "x" : "y"] += u, c[n ? "width" : "height"] *= 1.3, r ? r.intersect(c) ? (a++, o = Math.max(o, a)) :
										...
										var n = i(3),
											...
											s = n.extendShape({
												...
												buildPath: function(t, e) {
													...
													var f = .6 * a,
														p = .7 * a;
													t.bezierCurveTo(i + u - c * f, l + s + d * f, i, n - p, i, n), t.bezierCurveTo(i, n - p, i - u + c *
														f, l + s + d * f, i - u, l + s), t.closePath()
												}
											}),
											l = n.extendShape({
												type: "arrow",
												...
												buildPath: function(t, e) {
													var i = e.height,
														...
														o = e.y,
														a = n / 3 * 2;
													t.moveTo(r, o), t.lineTo(r + a, o + i), t.lineTo(r, o + i / 4 * 3), t.lineTo(r - a, o + i), t.lineTo(
														r, o), t.closePath()
												}
											}),
											h = {
										...
										var f = n.extendShape({
												...
												buildPath: function(t, e, i) {
													var n = e.symbolType,
														r = c[n];
													"none" !== e.symbolType && (r || (n = "rect", r = c[n]), u[n](e.x, e.y, e.width, e.height, r.shape),
											...
											p = function(t) {
												if ("image" !== this.type) {
													var e = this.style,
														i = this.shape;
													i && "line" === i.symbolType ? e.stroke = t : this.__isEmptyBrush ? (e.stroke = t, e.fill = "#fff") : (
										...
										function r(t, e, i, n) {
											return i = i || {}, n || !u.canvasSupported ? o(t, e, i) : u.browser.firefox && null != e.layerX && e.layerX !==
												e.offsetX ? (i.zrX = e.layerX, i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX, i.zrY = e.offsetY) :
												o(t, e, i), i
										}
										...
										_.prototype = {
											...
											beginPath: function(t) {
												return this._ctx = t, t && t.beginPath(), t && (this.dpr = t.dpr), this._len = 0, this._lineDash && (
											...
											lineTo: function(t, e) {
												...
												return this.addData(l.L, t, e), this._ctx && i && (this._needsDash() ? this._dashedLineTo(t, e) : this
													._ctx.lineTo(t, e)), i && (this._xi = t, this._yi = e), this
											},
											bezierCurveTo: function(t, e, i, n, r, o) {
												return this.addData(l.C, t, e, i, n, r, o), this._ctx && (this._needsDash() ? this._dashedBezierTo(t,
													e, i, n, r, o) : this._ctx.bezierCurveTo(t, e, i, n, r, o)), this._xi = r, this._yi = o, this
											},
											quadraticCurveTo: function(t, e, i, n) {
												return this.addData(l.Q, t, e, i, n), this._ctx && (this._needsDash() ? this._dashedQuadraticTo(t, e,
													i, n) : this._ctx.quadraticCurveTo(t, e, i, n)), this._xi = i, this._yi = n, this
											},
											arc: function(t, e, i, n, r, o) {
												return this.addData(l.A, t, e, i, i, n, r - n, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, i, n, r,
													o), this._xi = g(r) * i + t, this._yi = m(r) * i + t, this
											},
											...
											closePath: function() {
												...
												var t = this._ctx,
													e = this._x0,
													i = this._y0;
												return t && (this._needsDash() && this._dashedLineTo(e, i), t.closePath()), this._xi = e, this._yi = i,
													this
											},
											fill: function(t) {
											...
											_dashedLineTo: function(t, e) {
												var i, n, r = this._dashSum,
													...
													m = h,
													y = a.length;
												for (u /= d, c /= d, o < 0 && (o = r + o), o %= r, g -= o * u, m -= o * c; u > 0 && g <= t || u < 0 &&
													g >= t || 0 == u && (c > 0 && m <= e || c < 0 && m >= e);) n = this._dashIdx, i = a[n], g += u * i, m +=
													c * i, this._dashIdx = (n + 1) % y, u > 0 && g < l || u < 0 && g > l || c > 0 && m < h || c < 0 && m >
													h || s[n % 2 ? "moveTo" : "lineTo"](u >= 0 ? f(g, t) : p(g, t), c >= 0 ? f(m, e) : p(m, e));
											...
											_dashedBezierTo: function(t, e, i, r, o, a) {
												var s, l, h, u, c, d = this._dashSum,
													...
													w = p.length,
													M = 0;
												for (f < 0 && (f = d + f), f %= d, s = 0; s < 1; s += .1) l = x(m, t, i, o, s + .1) - x(m, t, i, o, s),
													h = x(y, e, r, a, s + .1) - x(y, e, r, a, s), _ += v(l * l + h * h);
												for (; b < w && (M += p[b], !(M > f)); b++);
												for (s = (M - f) / _; s <= 1;) u = x(m, t, i, o, s), c = x(y, e, r, a, s), b % 2 ? g.moveTo(u, c) : g.lineTo(
													u, c), s += p[b] / _, b = (b + 1) % w;
											...
											_dashedQuadraticTo: function(t, e, i, n) {
												var r = i,
													o = n;
												i = (i + 2 * t) / 3, n = (n + 2 * e) / 3, t = (this._xi + 2 * t) / 3, e = (this._yi + 2 * e) / 3, this
													._dashedBezierTo(t, e, i, n, r, o)
											},
											toStatic: function() {
												var t = this.data;
													...
													switch (1 == f && (e = t[f], i = t[f + 1], n = e, s = i), p) {
														...
														case l.A:
															var v = t[f++],
																...
																w = t[f++] + b,
																M = (t[f++], 1 - t[f++]);
															1 == f && (n = g(b) * x + v, s = m(b) * _ + y), o.fromArc(v, y, x, _, b, w, M, c, d), e = g(w) * x +
																v, i = m(w) * _ + y;
															break;
														case l.R:
															n = e = t[f++], s = i = t[f++];
												...
												for (var e, i, n, r, o, a, s = this.data, h = this._ux, u = this._uy, c = this._len, d = 0; d < c;) {
													...
													switch (1 == d && (n = s[d], r = s[d + 1], e = n, i = r), f) {
														case l.M:
															...
															break;
														case l.L:
															o = s[d++], a = s[d++], (y(o - n) > h || y(a - r) > u || d === c - 1) && (t.lineTo(o, a), n = o, r =
																a);
															break;
														case l.C:
														...
														case l.A:
															var p = s[d++],
																...
																C = Math.abs(x - _) > .001,
																k = b + w;
															C ? (t.translate(p, v), t.rotate(M), t.scale(A, I), t.arc(0, 0, T, b, k, 1 - S), t.scale(1 / A, 1 /
																I), t.rotate(-M), t.translate(-p, -v)) : t.arc(p, v, T, b, k, 1 - S), 1 == d && (e = g(b) * x + p,
																i = m(b) * _ + v), n = g(k) * x + p, r = m(k) * _ + v;
															break;
														case l.R:
										...
										a.prototype = {
											...
											remove: function(t) {
												var e = this.__zr,
													...
													r = this._children,
													o = n.indexOf(r, t);
												return o < 0 ? this : (r.splice(o, 1), t.parent = null, i && (i.delFromMap(t.id), t instanceof a && t.delChildrenFromStorage(
													i)), e && e.refresh(), this)
											},
											removeAll: function() {
												var t, e, i = this._children,
													n = this.__storage;
												for (e = 0; e < i.length; e++) t = i[e], n && (n.delFromMap(t.id), t instanceof a && t.delChildrenFromStorage(
													n)), t.parent = null;
											...
											getBoundingRect: function(t) {
												for (var e = null, i = new o(0, 0, 0, 0), n = t || this._children, r = [], a = 0; a < n.length; a++) {
													...
													if (!s.ignore && !s.invisible) {
														...
														h ? (i.copy(l), i.applyTransform(h), e = e || i.clone(), e.union(i)) : (e = e || l.clone(), e.union(
															l))
													}
												}
												return e || i
										...
										function o(t, e, i) {
											...
											var y = s ? s.categoryIndex : -1,
												...
												w = y >= 0 && r(t) ? function(t, e, i, n) {
													...
													return a && a[e] && "string" == typeof o && (b[e] = b[e] || a[e].getCategories(), o = c.indexOf(b[e], o),
														o < 0 && !isNaN(o) && (o = +o)), o
												};
										...
										var n = i(4),
											...
											u = o.extend({
												...
												unionExtent: function(t) {
													var e = this._extent;
													t[0] < e[0] && (e[0] = t[0]), t[1] > e[1] && (e[1] = t[1]), u.prototype.setExtent.call(this, e[0], e[
														1])
												},
												...
												getTicks: function() {
													...
													if (t) {
														...
														e[0] < r[0] && i.push(e[0]);
														for (var a = r[0]; a <= r[1];)
															if (i.push(a), a = h(a + t, o), i.length > n) return [];
												...
												niceTicks: function(t) {
													...
													if (isFinite(i)) {
														i < 0 && (i = -i, e.reverse());
														var r = h(n.nice(i / t, !0), Math.max(l(e[0]), l(e[1])) + 2),
															o = l(r) + 2,
										...
										s.updateData = function(t, e) {
											...
											t.diff(a).add(function(n) {
												...
												var c = a.getItemGraphicEl(u),
													d = t.getItemLayout(h);
												return r(t, h, e) ? (c ? (c.updateData(t, h, l), o.updateProps(c, {
														position: d
													}, n)) : (c = new s(t, h), c.attr("position", d)), i.add(c), void t.setItemGraphicEl(h, c)) : void i
													.remove(c)
											}).remove(function(t) {
										...
										var o = i(1),
											...
											f = s.extendComponentModel({
												...
												doInit: function(t) {
													var e = this.option;
													a.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), r("start", "startValue", t, e),
														r("end", "endValue", t, e), this.textStyleModel = this.getModel("textStyle"), this._resetTarget(),
													...
													t && d(function(e) {
														if (t) {
															...
															if (r.length && !n.length)
																for (var o = 0, a = r.length; o < a; o++) "category" === r[o].get("type") && n.push(o);
										...
										l.prototype = {
											...
											dataToCoord: function(t, e) {
												var i = this._extent,
													r = this.scale;
												return t = r.normalize(t), this.onBand && "ordinal" === r.type && (i = i.slice(), n(i, r.count())), o(
													t, s, i, e)
											},
											...
											getBands: function() {
												for (var t = this.getExtent(), e = [], i = this.scale.count(), n = t[0], r = t[1], o = r - n, a = 0; a <
													i; a++) e.push([o * a / i + n, o * (a + 1) / i + n]);
												return e
											},
										...
										function l(t, e) {
											...
											function o(i) {
												...
												n += d, r -= d, 0 !== r && (c = a(t[n + r - 1], t, o, c, c - 1, e), 0 !== c && (r <= c ? l(n, r, o, c) :
													h(n, r, o, c)))
											}
											...
											var x = [];
											v = g < 120 ? 5 : g < 1542 ? 10 : g < 119151 ? 19 : 40, u = [], f = [], this.mergeRuns = n, this.forceMergeRuns =
												r, this.pushRun = i
										}
										...
										i.throttle = function(t, e, i) {
											...
											e = e || 0;
											var c = function() {
												r = (new Date).getTime(), a = this, s = arguments, o = r - (i ? l : h) - e, clearTimeout(u), i ? u =
													setTimeout(n, e) : o >= 0 ? n() : u = setTimeout(n, -o), l = r
											};
											...
											brush: function(t, e) {
												...
												if (n.bind(t, this, e), i = "string" == typeof r ? this._image : r, !i && r) {
													...
													if (!o) return i = new Image, i.onload = function() {
														...
														image: i,
														pending: [this]
													}, i.src = r, l.put(r, o), void(this._image = i);
												...
												if (i) {
													...
													null == n.width && (n.width = a), null == n.height && (n.height = s), this.restoreTransform(t), null !=
										...
										c._createSymbol = function(t, e, i, n) {
											...
											var o = e.hostModel,
												...
												u = l.createSymbol(t, -1, -1, 2, 2, s);
											u.attr({
												z2: 100,
												culling: !0,
												scale: [0, 0]
											}), u.drift = a, h.initProps(u, {
												scale: r(n)
										...
										c._updateCommon = function(t, e, i, n) {
											...
											var c = n && n.itemStyle,
												m = n && n.hoverItemStyle,
												v = n && n.symbolRotate,
												y = n && n.symbolOffset,
												x = n && n.labelModel,
												_ = n && n.hoverLabelModel,
												b = n && n.hoverAnimation;
											if (!n || t.hasItemOption) {
												var w = t.getItemModel(e);
												c = w.getModel(d).getItemStyle(["color"]), m = w.getModel(f).getItemStyle(), v = w.getShallow(
													"symbolRotate"), y = w.getShallow("symbolOffset"), x = w.getModel(p), _ = w.getModel(g), b = w.getShallow(
													"hoverAnimation")
											} else m = s.extend({}, m);
											var M = o.style;
											o.attr("rotation", (v || 0) * Math.PI / 180 || 0), y && o.attr("position", [u.parsePercent(y[0], i[0]),
												u.parsePercent(y[1], i[1])
											]), o.setColor(l), o.setStyle(c);
											var S = t.getItemVisual(e, "opacity");
											null != S && (M.opacity = S);
											for (var T, A, I = t.dimensions.slice(); I.length && (T = I.pop(), A = t.getDimensionInfo(T).type,
													"ordinal" === A || "time" === A););
											null != T && x.getShallow("show") ? (h.setText(M, x, l), M.text = s.retrieve(a.getFormattedLabel(e,
												"normal"), t.get(T, e))) : M.text = "", null != T && _.getShallow("show") ? (h.setText(m, _, l), m.text =
												s.retrieve(a.getFormattedLabel(e, "emphasis"), t.get(T, e))) : m.text = "", o.off("mouseover").off(
												"mouseout").off("emphasis").off("normal"), o.hoverStyle = m, h.setHoverStyle(o);
											var C = r(i);
											if (b && a.isAnimationEnabled()) {
												var k = function() {
														var t = C[1] / C[0];
														this.animateTo({
															scale: [Math.max(1.1 * C[0], C[0] + 3), Math.max(1.1 * C[1], C[1] + 3 * t)]
														}, 400, "elasticOut")
													},
													L = function() {
														this.animateTo({
											...
											var e = this.childAt(0);
											this.silent = !0, e.style.text = "", h.updateProps(e, {
												scale: [0, 0]
										...
										function r(t, e, i) {
											...
											return f(o) ? (r = i > 0 ? "top" : "bottom", n = "center") : f(o - v) ? (r = i > 0 ? "bottom" : "top", n =
												"center") : (r = "middle", n = o > 0 && o < v ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"), {
												rotation: o,
												textAlign: n,
												verticalAlign: r
											}
										...
										function o(t, e, i, n) {
											var r, o, a = d(i - t.rotation),
												s = n[0] > n[1],
												l = "start" === e && !s || "start" !== e && s;
											return f(a - v / 2) ? (o = l ? "bottom" : "top", r = "center") : f(a - 1.5 * v) ? (o = l ? "top" :
												"bottom", r = "center") : (o = "middle", r = a < 1.5 * v && a > v / 2 ? l ? "left" : "right" : l ?
												"right" : "left"), {
												rotation: a,
												textAlign: r,
												verticalAlign: o
										...
										var x = {
												...
												axisTick: function() {
													...
													if (t.get("axisTick.show") && !e.isBlank())
														for (var i = t.getModel("axisTick"), n = this.opt, r = i.getModel("lineStyle"), o = i.get("length"),
																a = b(i, n.labelInterval), l = e.getTicksCoords(i.get("alignWithLabel")), u = e.scale.getTicks(), c = [],
																d = [], f = this._transform, p = 0; p < l.length; p++)
															if (!_(e, p, a)) {
																var m = l[p];
																c[0] = m, c[1] = 0, d[0] = m, d[1] = n.tickDirection * o, f && (g(c, c, f), g(d, d, f)), this.group
												...
												axisLabel: function() {
													function t(t, e) {
														...
														if (i && n) return i.applyTransform(t.getLocalTransform()), n.applyTransform(e.getLocalTransform()),
															i.intersect(n)
													}
													var e = this.opt,
														i = this.axisModel,
														o = i.axis,
														l = m(e.axisLabelShow, i.get("axisLabel.show"));
													if (l && !o.isBlank()) {
														var c = i.getModel("axisLabel"),
														...
														if (s.each(p, function(t, r) {
																if (!_(o, r, e.labelInterval)) {
																	...
																	var s = a.getTextColor() || i.get("axisLine.lineStyle.color"),
																		l = o.dataToCoord(t),
																		c = [l, e.labelOffset + e.labelDirection * f],
																		p = o.scale.getLabel(t),
																		m = new h.Text({
																			anid: "label_" + t,
																			style: {
																				text: g[r],
																	...
																	S && (m.eventData = n(i), m.eventData.targetType = "axisLabel", m.eventData.value = p), this._dumbGroup
																		.add(m), m.updateTransform(), w.push(m), this.group.add(m), m.decomposeTransform()
																}
															}, this), null != i.getMin()) {
															var T = w[0],
																A = w[1];
												...
												axisName: function() {
													...
													if (i) {
														var u, c = e.get("nameLocation"),
															d = t.nameDirection,
															f = e.getModel("nameTextStyle"),
															p = e.get("nameGap") || 0,
															g = this.axisModel.axis.getExtent(),
															y = g[0] > g[1] ? -1 : 1,
															x = ["start" === c ? g[0] - y * p : "end" === c ? g[1] + y * p : (g[0] + g[1]) / 2, "middle" === c ?
																t.labelOffset + d * p : 0
															],
															_ = e.get("nameRotate");
														null != _ && (_ = _ * v / 180);
														var b;
														"middle" === c ? u = r(t, null != _ ? _ : t.rotation, d) : (u = o(t, c, _ || 0, g), b = t.axisNameAvailableWidth,
															null != b && (b = Math.abs(b / Math.sin(u.rotation)), !isFinite(b) && (b = null)));
														var w = f.getFont(),
														...
														e.get("triggerEvent") && (L.eventData = n(e), L.eventData.targetType = "axisName", L.eventData.name =
															i), this._dumbGroup.add(L), L.updateTransform(), this.group.add(L), L.decomposeTransform()
													}
												}
											},
											_ = y.ifIgnoreOnTick = function(t, e, i) {
												var n, r = t.scale;
												return "ordinal" === r.type && ("function" == typeof i ? (n = r.getTicks()[e], !i(n, r.getLabel(n))) : e %
													(i + 1))
											},
										...
										v.type = "grid", v.getRect = function() {
											...
											var n = h.getLayoutRect(t.getBoxLayoutParams(), {
												width: e.getWidth(),
												height: e.getHeight()
											});
											this._rect = n;
											...
											i(), t.get("containLabel") && (p(o, function(t) {
												if (!t.model.get("axisLabel.inside")) {
													...
													if (e) {
														...
														n[i] -= e[i] + o, "top" === t.position ? n.y += e.height + o : "left" === t.position && (n.x += e.width +
															o)
													}
												}
											}), i())
											...
											return n.cartesian ? n.cartesian.dataToPoint(i) : n.axis ? n.axis.toGlobalCoord(n.axis.dataToCoord(i)) :
												null
										}, v.convertFromPixel = function(t, e, i) {
											var n = this._findConvertTarget(t, e);
											return n.cartesian ? n.cartesian.pointToData(i) : n.axis ? n.axis.coordToData(n.axis.toLocalCoord(i)) :
												null
											...
											var i, n, r = e.seriesModel,
												...
												s = e.gridModel,
												l = this._coordsList;
											if (r) i = r.coordinateSystem, c.indexOf(l, i) < 0 && (i = null);
											...
											function r(i) {
												return function(r, l) {
													if (n(r, t, e)) {
														...
														"x" === i ? "top" !== h && "bottom" !== h && (h = "bottom", o[h] && (h = "top" === h ? "bottom" :
															"top")) : "left" !== h && "right" !== h && (h = "left", o[h] && (h = "left" === h ? "right" :
															"left")), o[h] = !0;
														var c = new f(i, u.createScaleByModel(r), [0, 0], r.get("type"), h),
															d = "category" === c.type;
											...
											return e.eachComponent("xAxis", r("x"), this), e.eachComponent("yAxis", r("y"), this), s.x && s.y ? (
												this._axesMap = a, void p(a.x, function(t, e) {
													p(a.y, function(i, n) {
														var r = "x" + e + "y" + n,
															o = new d(r);
											...
											c.each(this._axesList, function(t) {
												...
												if (l(r)) {
													...
													var u = this.getCartesian(a.componentIndex, h.componentIndex),
														c = r.getData(),
														d = u.getAxis("x"),
														f = u.getAxis("y");
												...
												e.extend({
													...
													mergeDefaultAndTheme: function(e, n) {
														var s = this.layoutMode,
															...
															h = n.getTheme();
														r.merge(e, h.get(o + "Axis")), r.merge(e, this.getDefaultOption()), e.type = i(t, e), s && a.mergeLayoutParam(
															e, l, s)
													},
										...
										var s = a.prototype;
										s.updateView = s.updateLayout = s.updateVisual = function(t, e, i, n) {}, o.enableClassExtend(a), o.enableClassManagement(
											a, {
												registerWhenExtend: !0
											}), t.exports = a
									}, function(t, e, i) {
										...
										function u(t, e, i, n, r, o, a, s, l) {
											...
											if (1 == l)
												...
												for (var d = t[0].length, u = 0; u < h; u++)
													for (var f = 0; f < d; f++) s[u][f] = c(t[u][f], e[u][f], i[u][f], n[u][f], r, o, a)
										}
										...
										function p(t, e, i, n, r) {
											...
											if (x) {
												...
												if (!k) {
													for (var O = I[x - 1], L = 0; L < x - 1; L++) w ? l(I[L], O, T) : !isNaN(I[L]) || isNaN(O) || S || M ||
														(I[L] = O);
													...
													var W = function(t, e) {
															...
															if (0 !== n)
																if (E = (e - A[i]) / n, v)
																	if (R = I[i], N = I[0 === i ? i : i - 1], B = I[i > x - 2 ? x - 1 : i + 1], V = I[i > x - 3 ? x - 1 :
																			i + 2], w) u(N, R, B, V, E, E * E, E * E * E, d(t, r), T);
																	else {
																		var l;
																		if (M) l = u(N, R, B, V, E, E * E, E * E * E, H, 1), l = f(H);
																		else {
																			if (S) return a(R, B, E);
															...
															else if (w) s(I[i], I[i + 1], E, d(t, r), T);
															else {
																var l;
																if (M) s(I[i], I[i + 1], E, H, 1), l = f(H);
																else {
										...
										var g = i(145),
											...
											_ = function(t, e, i, o) {
												this._tracks = {}, this._target = t, this._loop = e || !1, this._getter = i || n, this._setter = o || r,
										...
										t.exports = "undefined" != typeof window && (window.requestAnimationFrame || window.msRequestAnimationFrame ||
										...
										o.prototype = {
											...
											bind: function(t, e, i) {
												...
												if ((a || n.fill !== o.fill) && (t.fillStyle = n.fill), (a || n.stroke !== o.stroke) && (t.strokeStyle =
														n.stroke), (a || n.opacity !== o.opacity) && (t.globalAlpha = null == n.opacity ? 1 : n.opacity), (a ||
														n.blend !== o.blend) && (t.globalCompositeOperation = n.blend || "source-over"), this.hasStroke()) {
													var u = n.lineWidth;
											...
											getGradient: function(t, e, r) {
												for (var o = "radial" === e.type ? n : i, a = o(t, e, r), s = e.colorStops, l = 0; l < s.length; l++) a
											...
											u = i(2).extendComponentModel({
												...
												formatTooltip: function(t) {
													var e = this.getData(),
														...
														r = e.getName(t),
														a = h(this.name);
													return (null != i || r) && (a += "<br />"), r && (a += h(r), null != i && (a += " : ")), null != i &&
														(a += h(n)), a
												},
												getData: function() {
													return this._data
										...
										var s = i(1),
											...
											d = function(t, e) {
												...
												if (e && !r(e) && !s.isArray(e.coord) && n) {
													...
													if (e = s.clone(e), e.type && c[e.type] && a.baseAxis && a.valueAxis) {
														var l = h(o, a.baseAxis.dim),
															u = h(o, a.valueAxis.dim);
											...
											f = function(t, e, i, n) {
												...
												return null != t.valueIndex || null != t.valueDim ? (r.valueDataDim = null != t.valueIndex ? e.getDimension(
														t.valueIndex) : t.valueDim, r.valueAxis = i.getAxis(n.dataDimToCoordDim(r.valueDataDim)), r.baseAxis =
													i.getOtherAxis(r.valueAxis), r.baseDataDim = n.coordDimToDataDim(r.baseAxis.dim)[0]) : (r.baseAxis = n
													.getBaseAxis(), r.valueAxis = i.getOtherAxis(r.baseAxis), r.baseDataDim = n.coordDimToDataDim(r.baseAxis
														.dim)[0], r.valueDataDim = n.coordDimToDataDim(r.valueAxis.dim)[0]), r
											},
											p = function(t, e) {
										...
										o.fromCubic = function(t, e, i, n, o, l, h, u, c, d) {
											...
											c[0] = a(t, c[0]), d[0] = s(t, d[0]), c[0] = a(h, c[0]), d[0] = s(h, d[0]), c[1] = a(e, c[1]), d[1] = s(
												e, d[1]), c[1] = a(u, c[1]), d[1] = s(u, d[1])
											...
											if (u[0] = h(o) * i + t, u[1] = l(o) * r + e, c[0] = h(a) * i + t, c[1] = l(a) * r + e, m(p, u, c), v(g,
													u, c), o %= f, o < 0 && (o += f), a %= f, a < 0 && (a += f), o > a && !s ? a += f : o < a && s && (o +=
													f), s) {
												var x = a;
												a = o, o = x
											}
											for (var _ = 0; _ < a; _ += Math.PI / 2) _ > o && (d[0] = h(_) * i + t, d[1] = l(_) * r + e, m(p, d, p),
												v(g, d, g))
										}, t.exports = o
									}, function(t, e, i) {
										var n = i(36),
										...
										a.prototype = {
											...
											brush: function(t, e) {
												...
												if (null != a && (a += ""), i.bind(t, this, e), a) {
													...
													t.font = h || "12px sans-serif", t.textAlign = l || "left", t.textAlign !== l && (t.textAlign =
														"left"), t.textBaseline = s || "alphabetic", t.textBaseline !== s && (t.textBaseline = "alphabetic");
													for (var c = o.measureText("国", t.font).width, d = a.split("\n"), f = 0; f < d.length; f++) i.hasFill() &&
														t.fillText(d[f], n, r), i.hasStroke() && t.strokeText(d[f], n, r), r += c;
											...
											drawRectText: function(t, e, i) {
												...
												if (null != s && (s += ""), s) {
													...
													o.textRotation && (v && t.translate(v[4], v[5]), t.rotate(o.textRotation), v && t.translate(-v[4], -v[
														5]));
													for (var w = 0; w < b.length; w++) x && t.fillText(b[w], l, h), _ && t.strokeText(b[w], l, h), h += i
														.lineHeight;
													t.restore()
												}
											}
										...
										var g = function(t, e, i) {
											...
											this.handler = new s(r, p, g, p.root), this.animation = new h({
												stage: {
										...
										g.prototype = {
											...
											dispose: function() {
												this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(),
													this.animation = this.storage = this.painter = this.handler = null, n(this.id)
											}
										}, t.exports = p
									}, function(t, e, i) {
										var n = i(2),
										...
										a.setLabel = function(t, e, i, o, a, s, l) {
											var h = i.getModel("label.normal"),
												u = i.getModel("label.emphasis");
											h.get("show") ? n(t, h, o, r.retrieve(a.getFormattedLabel(s, "normal"), a.getRawValue(s)), l) : t.text =
												"", u.get("show") ? n(e, u, o, r.retrieve(a.getFormattedLabel(s, "emphasis"), a.getRawValue(s)), l) : e
												.text = ""
										}, t.exports = a
									}, function(t, e, i) {
										function n(t) {
										...
										function r(t, e, i, r, o, a, g, m, v, y, x) {
											for (var _ = 0, b = i, w = 0; w < r; w++) {
												...
												if (b === i) t[a > 0 ? "moveTo" : "lineTo"](M[0], M[1]), c(f, M);
												else if (v > 0) {
													var S = b + a,
														T = e[S];
													if (x)
														for (; T && n(e[S]);) S += a, T = e[S];
													var A = .5,
														I = e[_],
														T = e[S];
													if (!T || n(T)) c(p, M);
													...
													l(f, f, m), h(f, f, g), l(p, p, m), h(p, p, g), t.bezierCurveTo(f[0], f[1], p[0], p[1], M[0], M[1]), u(
														f, M, d, v * A)
										...
										function o(t, e) {
											...
											if (e)
												for (var r = 0; r < t.length; r++) {
													var o = t[r];
													o[0] < i[0] && (i[0] = o[0]), o[1] < i[1] && (i[1] = o[1]), o[0] > n[0] && (n[0] = o[0]), o[1] > n[1] &&
														(n[1] = o[1])
												}
											return {
												min: e ? i : n,
										...
										t.exports = {
											Polyline: a.extend({
												...
												buildPath: function(t, e) {
													...
													for (; a < s;) a += r(t, i, a, s, s, 1, l.min, l.max, e.smooth, e.smoothMonotone, e.connectNulls) +
														1
												}
											}),
											Polygon: a.extend({
										...
										function h(t, e) {
											...
											u.call(this), this.setContainsPoint = function(t) {
												...
												this.disable(), null == e && (e = !0), e !== !0 && "move" !== e && "pan" !== e || (t.on("mousedown", l),
													t.on("mousemove", h), t.on("mouseup", d)), e !== !0 && "scale" !== e && "zoom" !== e || (t.on(
													"mousewheel", f), t.on("pinch", p))
											}, this.disable = function() {
												t.off("mousedown", l), t.off("mousemove", h), t.off("mouseup", d), t.off("mousewheel", f), t.off(
													"pinch", p)
										...
										t.exports = function(t, e, i, n, r) {
											function o(t, e, i) {
												...
												return e[0] > e[1] && n.reverse(), t < 0 && n[0] + t < i[0] && (t = i[0] - n[0]), t > 0 && n[1] + t > i[
													1] && (t = i[1] - n[1]), t
											}
											return t ? ("rigid" === n ? (t = o(t, e, i), e[0] += t, e[1] += t) : (t = o(t, e[r], i), e[r] += t,
												"push" === n && e[0] > e[1] && (e[1 - r] = e[r])), e) : e
										}
									}, function(t, e, i) {
										var n = i(1),
											r = {
										...
										function o(t, e) {
											...
											s.each(t, function(t, e) {
												var o = t.getData(),
													...
													s = a.getBaseAxis(),
													l = s.getExtent(),
													u = "category" === s.type ? s.getBandWidth() : Math.abs(l[1] - l[0]) / o.count(),
													c = i[r(s)] || {
														bandWidth: u,
														remainedWidth: u,
														autoWidthCount: 0,
												...
												var p = h(t.get("barWidth"), u),
													g = h(t.get("barMaxWidth"), u),
													m = t.get("barGap"),
													v = t.get("barCategoryGap");
												p && !d[f].width && (p = Math.min(c.remainedWidth, p), d[f].width = p, c.remainedWidth -= p), g && (d[
													f].maxWidth = g), null != m && (c.gap = m), null != v && (c.categoryGap = v)
											});
											var o = {};
											...
											e.eachSeriesByType(t, function(t) {
												...
												l[s] = l[s] || [], h[s] = h[s] || [], e.setLayout({
													...
													if (!isNaN(t)) {
														...
														var n, r, o, a, u = t >= 0 ? "p" : "n",
															v = m[i],
															y = l[s][i][u],
															x = h[s][i][u];
														f.isHorizontal() ? (n = y, r = v[1] + c, o = v[0] - x, a = d, h[s][i][u] += o, Math.abs(o) < p &&
															(o = (o < 0 ? -1 : 1) * p), l[s][i][u] += o) : (n = v[0] + c, r = y, o = d, a = v[1] - x, h[s][i]
															[u] += a, Math.abs(a) < p && (a = (a <= 0 ? -1 : 1) * p), l[s][i][u] += a), e.setItemLayout(i, {
															x: n,
															y: r,
															width: o,
															height: a
										...
										t.exports = {
											containStroke: function(t, e, i, n, r, o, a) {
												...
												var s = r,
													l = 0,
													h = t;
												if (a > e + s && a > n + s || a < e - s && a < n - s || o > t + s && o > i + s || o < t - s && o < i -
													s) return !1;
										...
										t.exports = {
											containStroke: function(t, e, i, r, o, a, s, l, h) {
												if (0 === s) return !1;
												var u = s;
												if (h > e + u && h > r + u && h > a + u || h < e - u && h < r - u && h < a - u || l > t + u && l > i +
													u && l > o + u || l < t - u && l < i - u && l < o - u) return !1;
										...
										var n = i(1),
											...
											o = function(t, e, i, n, o, a) {
												this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == i ? 1 : i, this.y2 = null == n ?
													0 : n, this.type = "linear", this.global = a || !1, r.call(this, o)
											};
										o.prototype = {
											constructor: o
										...
										h.transform = null, h.needLocalTransform = function() {
											return n(this.rotation) || n(this.position[0]) || n(this.position[1]) || n(this.scale[0] - 1) || n(this.scale[
												1] - 1)
											...
											var t = this.parent,
												...
												n = this.transform;
											return i || e ? (n = n || r.create(), i ? this.getLocalTransform(n) : a(n), e && (i ? r.mul(n, t.transform,
													n) : r.copy(n, t.transform)), this.transform = n, this.invTransform = this.invTransform || r.create(),
												void r.invert(this.invTransform, n)) : void(n && a(n))
											...
											var e = this.origin,
												...
												n = this.rotation,
												o = this.position;
											return e && (t[4] -= e[0], t[5] -= e[1]), r.scale(t, t, i), n && r.rotate(t, t, n), e && (t[4] += e[0],
												t[5] += e[1]), t[4] += o[0], t[5] += o[1], t
										}, h.setTransform = function(t) {
											var e = this.transform,
												i = t.dpr || 1;
											e ? t.setTransform(i * e[0], i * e[1], i * e[2], i * e[3], i * e[4], i * e[5]) : t.setTransform(i, 0, 0,
												i, 0, 0)
										...
										h.decomposeTransform = function() {
											if (this.transform) {
												...
												var i = e[0] * e[0] + e[1] * e[1],
													...
													a = this.position,
													s = this.scale;
												n(i - 1) && (i = Math.sqrt(i)), n(o - 1) && (o = Math.sqrt(o)), e[0] < 0 && (i = -i), e[3] < 0 && (o = -
													o), a[0] = e[4], a[1] = e[5], s[0] = i, s[1] = o, this.rotation = Math.atan2(-e[1] / o, e[0] / i)
											}
										...
										var r = i(1),
											o = ["getDom", "getZr", "getWidth", "getHeight", "dispatchAction", "isDisposed", "on", "off",
												"getDataURL", "getConnectedDataURL", "getModel", "getOption"
											];
										t.exports = n
									}, function(t, e, i) {
										var n = i(1);
										...
										function n(t, e, i, n, r, o, a) {
											...
											if (o) {
												var u = s.shape,
													c = r ? "height" : "width",
													d = {};
												u[c] = 0, d[c] = n[c], h[a ? "updateProps" : "initProps"](s, {
													shape: d
												}, o, e)
											}
											return s
										...
										function a(t, e, i, n, r, o, a) {
											var s = e.getItemVisual(i, "color"),
												c = e.getItemVisual(i, "opacity"),
												d = n.getModel("itemStyle.normal"),
										...
										var l = i(1),
											h = i(3),
											u = i(81),
											c = ["itemStyle", "normal", "barBorderWidth"];
										...
										var d = i(2).extendChartView({
											...
											_renderOnCartesian: function(t, e, i) {
												...
												l.diff(u).add(function(e) {
													...
													var c = l.getItemModel(e),
														d = o(l, e, c);
													r ? h.updateProps(r, {
														shape: d
													}, p, e) : r = n(l, e, c, d, f, p, !0), l.setItemGraphicEl(e, r), s.add(r), a(r, l, e, c, d, t, f)
												}).remove(function(t) {
											...
											if (e || i || !n.ignore) {
												...
												if (this.__dirty || a.__dirty) {
													...
													if (!n.ignore) {
														n.attr("position", h);
														var f, p, g, m = 5 * r;
														if ("end" === n.__position) f = [c[0] * m + h[0], c[1] * m + h[1]], p = c[0] > .8 ? "left" : c[0] < -
										...
										m.beforeUpdate = s, m._createLine = function(t, e, i) {
											...
											if (!i || t.hasItemOption) {
												...
												o = h.getModel("lineStyle.normal").getLineStyle(), a = h.getModel("lineStyle.emphasis").getLineStyle(),
													s = h.getModel("label.normal"), l = h.getModel("label.emphasis")
											}
										...
										l.updateData = function(t) {
											...
											t.diff(e).add(function(e) {
												...
												return r(t.getItemLayout(o)) ? (l ? l.updateData(t, o, a) : l = new n(t, o, a), t.setItemGraphicEl(o,
													l), void i.add(l)) : void i.remove(l)
											}).remove(function(t) {
										...
										var n = i(1),
											r = i(2),
											o = r.PRIORITY;
										i(101), i(102), r.registerVisual(n.curry(i(45), "line", "circle", "line")), r.registerLayout(n.curry(i(56),
											"line")), r.registerProcessor(o.PROCESSOR.STATISTIC, n.curry(i(135), "line")), i(31)
									}, function(t, e, i) {
										"use strict";
										var n = i(35),
											r = i(16);
										...
										function c(t, e, i) {
											for (var n = e.getBaseAxis(), r = "x" === n.dim || "radius" === n.dim ? 0 : 1, o = [], a = 0; a < t.length -
												1; a++) {
												var s = t[a + 1],
													l = t[a];
												o.push(l);
										...
										t.exports = _.extend({
											...
											render: function(t, e, i) {
												...
												x && v.type === o.type && C === this._step ? (M && !_ ? _ = this._newPolygon(g, S, o, w) : _ && !M &&
													(b.remove(_), _ = this._polygon = null), b.setClipPath(u(o, !1, t)), T && y.updateData(l, A), l.eachItemGraphicEl(
														function(t) {
															t.stopAnimation(!0)
														}), n(this._stackedOnPoints, S) && n(this._points, g) || (w ? this._updateAnimation(l, S, o, i, C) :
													...
													o, w), M && (_ = this._newPolygon(g, S, o, w)), b.setClipPath(u(o, !0, t)));
												var k = d(l, o) || l.getVisual("color");
												x.useStyle(f.defaults(h.getLineStyle(), {
													fill: "none",
													stroke: k,
													lineJoin: "bevel"
												}));
											...
											_updateAnimation: function(t, e, i, n, r) {
												var o = this._polyline,
													...
													d = l.next,
													f = l.stackedOnNext;
												r && (h = c(l.current, i, r), u = c(l.stackedOnCurrent, i, r), d = c(l.next, i, r), f = c(l.stackedOnNext,
													i, r)), o.shape.__points = l.current, o.shape.points = h, v.updateProps(o, {
													shape: {
														points: d
													}
												}, s), a && (a.setShape({
										...
										function n(t, e, n) {
											for (var r, o = t.getBaseAxis(), a = t.getOtherAxis(o), s = o.onZero ? 0 : a.scale.getExtent()[0], l = a.dim,
													h = "x" === l || "radius" === l ? 1 : 0, u = e.stackedOn, c = e.get(l, n); u && i(u.get(l, n)) === i(c);) {
												r = u;
												break
											}
											var d = [];
										...
										t.exports = function(t, e, i, o, a, s) {
											for (var l = r(t, e), h = [], u = [], c = [], d = [], f = [], p = [], g = [], m = s.dimensions, v = 0; v <
												l.length; v++) {
												var y = l[v],
													x = !0;
												switch (y.cmd) {
													case "=":
														...
														(isNaN(_[0]) || isNaN(_[1])) && (_ = b.slice()), h.push(_), u.push(b), c.push(i[y.idx]), d.push(o[y.idx1]),
															g.push(e.getRawIndex(y.idx1));
														break;
													case "+":
														var w = y.idx;
														h.push(a.dataToPoint([e.get(m[0], w, !0), e.get(m[1], w, !0)])), u.push(e.getItemLayout(w).slice()),
															c.push(n(a, e, w)), d.push(o[w]), g.push(e.getRawIndex(w));
														break;
													case "-":
														var w = y.idx,
															M = t.getRawIndex(w);
														M !== w ? (h.push(t.getItemLayout(w)), u.push(s.dataToPoint([t.get(m[0], w, !0), t.get(m[1], w, !0)])),
															c.push(i[w]), d.push(n(s, t, w)), g.push(M)) : x = !1
												}
										...
										i(105), i(106), i(79)("pie", [{
											...
											event: "pieunselected",
											method: "unSelect"
										}]), r.registerVisual(n.curry(i(74), "pie")), r.registerLayout(n.curry(i(108), "pie")), r.registerProcessor(
											n.curry(i(58), "pie"))
									}, function(t, e, i) {
										"use strict";
										var n = i(14),
										...
										function o(t, e) {
											...
											var r = new s.Sector({
												...
												o = new s.Polyline,
												a = new s.Text;
											this.add(r), this.add(o), this.add(a), this.updateData(t, e, !0), this.on("emphasis", i).on("normal", n).on(
										...
										h.updateData = function(t, e, i) {
											...
											if (d.label = null, i) {
												...
												}, h, e)) : (a.shape.endAngle = c.startAngle, s.updateProps(a, {
													shape: {
														endAngle: c.endAngle
													}
												}, h, e))
											...
											a.useStyle(l.defaults({
													...
													t.getItemLayout(e), u.get("selected"), h.get("selectedOffset"), h.get("animation")), a.off("mouseover")
												.off("mouseout").off("emphasis").off("normal"), u.get("hoverAnimation") && h.isAnimationEnabled() && a.on(
													"mouseover", n).on("mouseout", o).on("emphasis", n).on("normal", o), this._updateLabel(t, e), s.setHoverStyle(
													this)
											...
											n.setStyle(a(t, e, "normal", c, g)), n.ignore = n.normalIgnore = !c.get("show"), n.hoverIgnore = !d.get(
													"show"), i.ignore = i.normalIgnore = !f.get("show"), i.hoverIgnore = !p.get("show"), i.setStyle({
													stroke: u,
													opacity: t.getItemVisual(e, "opacity")
												}), i.setStyle(f.getModel("lineStyle").getLineStyle()), n.hoverStyle = a(t, e, "emphasis", d, g), i.hoverStyle =
										...
										function n(t, e, i, n, r, o, a) {
											...
											for (var u, c = 0, d = t.length, f = [], p = [], g = 0; g < d; g++) u = t[g].y - c, u < 0 && s(g, d, -u,
										...
										function r(t, e, i, r, o, a) {
											...
											for (var h = 0; h < t.length; h++) {
												...
												if (u) {
													var c = u[1][0] - u[2][0];
													t[h].x < e ? u[2][0] = t[h].x + 3 : u[2][0] = t[h].x - 3, u[1][1] = u[2][1] = t[h].y, u[1][0] = u[2][0] +
														c
												}
											}
										}
										...
										t.exports = function(t, e, i, n) {
											var a, s, l = t.getData(),
												...
												u = !1;
											l.each(function(i) {
												var n, r, c, d, f = l.getItemLayout(i),
													p = l.getItemModel(i),
												...
												var L = g.getModel("textStyle").getFont(),
													...
													D = t.getFormattedLabel(i, "normal") || l.getName(i),
													O = o.getBoundingRect(D, L, d, "top");
												u = !!P, f.label = {
													x: n,
													y: r,
													position: m,
										...
										t.exports = function(t, e, i, h) {
											e.eachSeriesByType(t, function(t) {
												...
												if (v.each("value", function(t, e) {
														...
														i = "area" !== M ? 0 === _ && S ? b : t * b : s / (v.count() || 1), i < x ? (i = x, A -= x) : I +=
															t;
														var r = C + k * i;
														v.setItemLayout(e, {
															angle: i,
										...
										function n(t, e) {
											...
											d.x.onZero = Math.max(Math.min(i("y"), d.x.bottom), d.x.top), d.y.onZero = Math.max(Math.min(i("x"), d.y.right),
													d.y.left), o.position = ["y" === l ? d.y[s] : u[0], "x" === l ? d.x[s] : u[3]], o.rotation = Math.PI /
												2 * ("x" === l ? 0 : 1);
											var f = {
												top: -1,
												bottom: 1,
											...
											o.labelDirection = o.tickDirection = o.nameDirection = f[a], r.onZero && (o.labelOffset = d[l][a] - d[l].onZero),
												e.getModel("axisTick").get("inside") && (o.tickDirection = -o.tickDirection), e.getModel("axisLabel").get(
													"inside") && (o.labelDirection = -o.labelDirection);
												...
												_splitLine: function(t, e, i) {
													...
													if (!n.isBlank()) {
														var a = t.getModel("splitLine"),
															...
															c = l(a, i);
														u = r.isArray(u) ? u : [u];
														for (var d = e.coordinateSystem.getRect(), f = n.isHorizontal(), p = 0, g = n.getTicksCoords(), m =
																n.scale.getTicks(), v = [], y = [], x = h.getLineStyle(), _ = 0; _ < g.length; _++)
															if (!s(n, _, c)) {
													...
													if (!n.isBlank()) {
														...
														for (var x = 1; x < d.length; x++)
															if (!s(n, x, v)) {
																...
																n.isHorizontal() ? (_ = p, b = c.y, w = S - _, M = c.height) : (_ = c.x, b = g, w = c.width, M = S -
																	b);
																var T = m++ % u.length;
										...
										function n(t) {
											R.call(this), this._zr = t, this.group = new F.Group, this._brushType, this._brushOption, this._panels,
												this._track = [], this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan,
												this._uid = "brushController_" + it++, this._handlers = {}, Z(nt, function(t, e) {
										...
										function x(t, e, i, n) {
											var r = n.brushStyle.lineWidth || 0,
												...
												m = p + r,
												v = g + r;
											b(t, e, "main", a, s, p, g), n.transformable && (b(t, e, "w", l, h, o, v), b(t, e, "e", d, h, o, v), b(t,
												e, "n", l, h, m, o), b(t, e, "s", l, f, m, o), b(t, e, "nw", l, h, o, o), b(t, e, "ne", d, h, o, o), b(
										...
										function A(t, e, i, n, r, o, a, s) {
											...
											Z(r.split(""), function(t) {
												var e = J[t];
												h[e[0]][e[1]] += c[e[0]]
											}), l.range = e(M(h[0][0], h[1][0], h[0][1], h[1][1])), u(i, n), g(i, {
												isEnd: !1
											})
										}
										...
										function P(t, e) {
											var i = e.offsetX,
												...
												r = t._zr;
											if (t._brushType) {
												for (var o, a = t._panels, s = t._covers, l = 0; l < s.length; l++)
											...
											if (t._track.push(t.group.transformCoordToLocal(r, o)), m(t) || h) {
												...
												if (h) {
													var g = rt[t._brushType],
														v = h.__brushOption;
													v.range = g.getCreatingRange(k(t, h, t._track)), i && (s(t, h), g.updateCommon(t, h)), l(t, h), n = {
														isEnd: i
													}
												}
										...
										n.prototype = {
											...
											setPanels: function(t) {
												...
												return i && Z(t, function(t) {
													...
													var a = t.rect;
													a instanceof V || (a = V.create(a)), o.attr("shape", a.plain()), o.__brushPanelId = r, i[r] = o, e[
														r] = null
												}), Z(e, function(t) {
													t && n.remove(t)
												}), this
										...
										h.parseOutputRanges = function(t, e, i, n) {
											...
											l(t.areas, function(e) {
												...
												e.range = e.range || [], i && i !== !0 && (e.range = f[e.brushType](0, i, e.coordRange), e.panelId =
													i.panelId)
											})
											...
											return l(t, function(t) {
												var i, n = t.coordSys;
												t.geoIndex >= 0 ? (i = n.getBoundingRect().clone(), i.applyTransform(s.getTransform(n))) : i = n.grid
													.getRect().clone(), e.push({
														panelId: t.panelId,
														rect: i
													})
											}), e
											...
											return l(u, function(n) {
												var r = t[n + "Index"];
												null != r && "none" !== r && ("all" === r || a.isArray(r) || (r = [r]), e.eachComponent({
													mainType: n
												}, function(t, e) {
													if (!("all" !== r && a.indexOf(r, e) < 0)) {
														...
														}!l && i.push(l = {}), l[n] = t, l[n + "Index"] = e, l.panelId = n + c + e, l.coordSys = s || o.getCartesian(
															l.xAxisIndex, l.yAxisIndex), l.coordSys ? i[n + "Has"] = !0 : i.pop()
													}
												}))
											}), i
										...
										t.exports = function(t) {
											var e = t.model,
												...
												o = i.get("interval");
											return "category" !== t.type || "auto" !== o ? "auto" === o ? 0 : o : r.getAxisLabelInterval(n.map(t.scale
												.getTicks(), t.dataToCoord, t), e.getFormattedLabels(), i.getModel("textStyle").getFont(), t.isHorizontal())
										}
									}, function(t, e, i) {
										var n = i(3),
											r = i(1),
										...
										function n(t, e) {
											u.each(e, function(e, i) {
												x.hasClass(i) || ("object" == typeof e ? t[i] = t[i] ? u.merge(t[i], e, !1) : u.clone(e) : null == t[i] &&
													(t[i] = e))
											})
										}

										function r(t) {
											t = t, this.option = {}, this.option[b] = 1, this._componentsMap = {}, this._seriesIndices = null, n(t,
												this._theme.option), u.merge(t, _, !1), this.mergeOption(t)
										}
											...
											w = d.extend({
												...
												resetOption: function(t) {
													...
													if (!t || "recreate" === t) {
														...
														this.option && "recreate" !== t ? (this.restoreData(), this.mergeOption(n)) : r.call(this, n), e = !
															0
													}
												...
												getOption: function() {
													...
													return f(t, function(e, i) {
														if (x.hasClass(i)) {
															for (var e = c.normalizeToArray(e), n = e.length - 1; n >= 0; n--) c.isIdInner(e[n]) && e.splice(
																n, 1);
															t[i] = e
														}
													}), delete t[b], t
												...
												eachComponent: function(t, e, i) {
													...
													else if (u.isString(t)) f(n[t], e, i);
													else if (y(t)) {
										...
										n.prototype = {
											...
											setOption: function(t, e) {
												...
												var i = this._optionBackup,
													n = r.call(this, t, e, !i);
												this._newBaseOption = n.baseOption, i ? (l(i.baseOption, n.baseOption), n.timelineOptions.length && (i
														.timelineOptions = n.timelineOptions), n.mediaList.length && (i.mediaList = n.mediaList), n.mediaDefault &&
										...
										t.exports = {
											...
											getFont: function() {
												...
												return [this.getShallow("fontStyle") || n(e, "fontStyle"), this.getShallow("fontWeight") || n(e,
													"fontWeight"), (this.getShallow("fontSize") || n(e, "fontSize") || 12) + "px", this.getShallow(
													"fontFamily") || n(e, "fontFamily") || "sans-serif"].join(" ")
											},
										...
										var a = i(1),
											...
											u = ["bar", "boxplot", "candlestick", "chord", "effectScatter", "funnel", "gauge", "lines", "graph",
										...
										function n(t) {
											...
											e && r.each(o, function(i) {
												var n = e.normal,
													o = e.emphasis;
												n && n[i] && (t[i] = t[i] || {}, t[i].normal ? r.merge(t[i].normal, n[i]) : t[i].normal = n[i], n[i] =
													null), o && o[i] && (t[i] = t[i] || {}, t[i].emphasis ? r.merge(t[i].emphasis, o[i]) : t[i].emphasis =
													o[i], o[i] = null)
											})
										}
										var r = i(1),
										...
										t.exports = function(t) {
											if (t) {
												...
												if (e) {
													...
													var o = t.markPoint;
													if (o && o.data)
														for (var a = o.data, i = 0; i < a.length; i++) n(a[i]);
													var s = t.markLine;
													if (s && s.data)
														for (var l = s.data, i = 0; i < l.length; i++) r.isArray(l[i]) ? (n(l[i][0]), n(l[i][1])) : n(l[i])
												}
											}
										}
									}, function(t, e) {
										...
										t.exports = function(t, e, r) {
											e.eachSeriesByType(t, function(t) {
												...
												if ("cartesian2d" === o.type && r) {
													...
													if (u > 1) {
														var c;
														"string" == typeof r ? c = i[r] : "function" == typeof r && (c = r), c && (e = e.downSample(s.dim,
															1 / u, c, n), t.setData(e))
													}
												}
											}, this)
											...
											m = o.extend({
												...
												getTicks: function() {
													...
													return r.map(h.getTicks.call(this), function(r) {
														...
														return o = r === e[0] && t.__fixMin ? n(o, i[0]) : o, o = r === e[1] && t.__fixMax ? n(o, i[1]) :
															o
													}, this)
												},
												getLabel: h.getLabel,
										...
										t.exports = function(t) {
											function e(e) {
												...
												r.setVisual("color", o), t.isSeriesFiltered(e) || ("function" != typeof o || o instanceof n || r.each(
													function(t) {
										...
										var h = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
											u = function(t, e, i, n) {
												l.call(this), this.storage = t, this.painter = e, this.painterRoot = n, i = i || new r, this.proxy = i,
													i.handler = this, this._hovered, this._lastTouchMoment, this._lastX, this._lastY, s.call(this), a.each(
														h,
														function(t) {
										...
										u.prototype = {
											...
											mousemove: function(t) {
												var e = t.zrX,
													...
													r = this._hovered,
													o = this.proxy;
												this._hovered = n, o.setCursor && o.setCursor(n ? n.cursor : "default"), r && n !== r && r.__zr &&
													this.dispatchToElement(r, "mouseout", t), this.dispatchToElement(n, "mousemove", t), n && n !== r &&
													this.dispatchToElement(n, "mouseover", t)
											},
											mouseout: function(t) {
											...
											dispatchToElement: function(t, e, i) {
												for (var r = "on" + e, o = n(e, t, i), a = t; a && (a[r] && (o.cancelBubble = a[r].call(a, o)), a.trigger(
														e, o), a = a.parent, !o.cancelBubble););
											...
											findHover: function(t, e, i) {
												for (var n = this.storage.getDisplayList(), r = n.length - 1; r >= 0; r--)
													if (!n[r].silent && n[r] !== i && !n[r].ignore && o(n[r], t, e)) return n[r]
											}
										...
										function r(t, e, i, n) {
											...
											return s.position = "absolute", s.left = 0, s.top = 0, s.width = o + "px", s.height = a + "px", r.width =
												o * n, r.height = a * n, r.setAttribute("data-zr-dom-id", t), r
										}
										var o = i(1),
											a = i(33),
											s = i(66),
											...
											h = function(t, e, i) {
												var s;
												i = i || a.devicePixelRatio, "string" == typeof t ? s = r(t, "canvas", e, i) : o.isObject(t) && (s = t,
													t = s.id), this.id = t, this.dom = s;
												var l = s.style;
												l && (s.onselectstart = n, l["-webkit-user-select"] = "none", l["user-select"] = "none", l[
													...
													.config = null, this.clearColor = 0, this.motionBlur = !1, this.lastFrameAlpha = .7, this.dpr = i
											};
										h.prototype = {
											constructor: h,
											elCount: 0,
											...
											resize: function(t, e) {
												var i = this.dpr,
													...
													r = n.style,
													o = this.domBack;
												r.width = t + "px", r.height = e + "px", n.width = t * i, n.height = e * i, o && (o.width = t * i, o.height =
											...
											clear: function(t) {
												...
												if (a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy",
														this.ctxBack.drawImage(e, 0, 0, n / u, r / u)), i.clearRect(0, 0, n, r), o) {
													var c;
													o.colorStops ? (c = o.__canvasGradient || s.getGradient(i, o, {
															...
															width: n,
															height: r
														}), o.__canvasGradient = c) : o.image && (c = l.prototype.getCanvasPattern.call(o, i)), i.save(), i.fillStyle =
														c || o, i.fillRect(0, 0, n, r), i.restore()
												}
												if (a) {
													var d = this.domBack;
										...
										function u(t, e) {
											...
											return i.style.cssText = ["position:relative", "overflow:hidden", "width:" + t + "px", "height:" + e +
										...
										var c = i(33),
											...
											b = function(t, e, i) {
												...
												this._opts = i = d.extend({}, i || {}), this.dpr = i.devicePixelRatio || c.devicePixelRatio, this._singleCanvas =
													n, this.root = t;
												var r = t.style;
										...
										b.prototype = {
												...
												if (i && i.clear(), e) {
													...
													for (var r = 0; r < e;) {
														...
														a && a.__zr ? (r++, a.invisible || (o.transform = a.transform, o.invTransform = a.invTransform, o.__clipPaths =
															a.__clipPaths, this._doPaintEl(o, i, !0, n))) : (t.splice(r, 1), a.__hoverMir = null, e--)
													}
													i.ctx.restore()
												}
											},
											_startProgessive: function() {
												function t() {
													i === e._progressiveToken && e.storage && (e._doPaintList(e.storage.getDisplayList()), e._furtherProgressive ?
											...
											_paintList: function(t, e) {
												null == e && (e = !1), this._updateLayerStatus(t), this._clearProgressive(), this.eachBuildinLayer(o),
													this._doPaintList(t, e), this.eachBuildinLayer(a)
											},
											_doPaintList: function(t, e) {
												function i(t) {
													var e = o.dpr || 1;
													o.save(), o.globalAlpha = 1, o.shadowBlur = 0, n.__dirty = !0, o.setTransform(1, 0, 0, 1, 0, 0), o.drawImage(
														t.dom, 0, 0, u * e, c * e), o.restore()
												}
												for (var n, r, o, a, s, l, h = 0, u = this._width, c = this._height, p = this._progress, g = 0, m = t.length; g <
													m; g++) {
													var v = t[g],
														x = this._singleCanvas ? 0 : v.zlevel,
														_ = v.__frame;
													if (_ < 0 && s && (i(s), s = null), r !== x && (o && o.restore(), a = {}, r = x, n = this.getLayer(r),
															n.isBuildin || f("ZLevel " + r + " has been used by unkown layer " + n.id), o = n.ctx, o.save(), n.__unusedCount =
															0, (n.__dirty || e) && n.clear()), n.__dirty || e) {
														if (_ >= 0) {
															if (!s) {
																if (s = this._progressiveLayers[Math.min(h++, y - 1)], s.ctx.save(), s.renderScope = {}, s && s.__progress >
																	s.__maxProgress) {
											...
											_doPaintEl: function(t, e, i, n) {
												var r = e.ctx,
													o = t.transform;
												if ((e.__dirty || i) && !t.invisible && 0 !== t.style.opacity && (!o || o[0] || o[3]) && (!t.culling ||
														!s(t, this._width, this._height))) {
													var a = t.__clipPaths;
													(n.prevClipLayer !== e || l(a, n.prevElClipPaths)) && (n.prevElClipPaths && (n.prevClipLayer.ctx.restore(),
														n.prevClipLayer = n.prevElClipPaths = null, n.prevEl = null), a && (r.save(), h(a, r), n.prevClipLayer =
														e, n.prevElClipPaths = a)), t.beforeBrush && t.beforeBrush(r), t.brush(r, n.prevEl || null), n.prevEl =
											...
											getLayer: function(t) {
												...
												return e || (e = new m("zr_" + t, this, this.dpr), e.isBuildin = !0, this._layerConfig[t] && d.merge(e,
													this._layerConfig[t], !0), this.insertLayer(t, e), e.initContext()), e
											},
												...
												for (var o, a, s = 0, l = 0, h = 0, u = t.length; h < u; h++) {
													...
													if (p && (p.elCount++, p.__dirty = p.__dirty || c.__dirty), g >= 0) {
														...
														if (!o) {
															...
															o = i[x], o || (o = i[x] = new m("progressive", this, this.dpr), o.initContext()), o.__maxProgress =
																0
														}
											...
											resize: function(t, e) {
												...
												var n = this._opts;
												if (null != t && (n.width = t), null != e && (n.height = e), t = this._getSize(0), e = this._getSize(1),
													i.style.display = "", this._width != t || e != this._height) {
											...
											_pathToImage: function(t, e, n, r, o) {
												...
												return null != l.position && (u.position = e.position = l.position), null != l.rotation && (u.rotation =
													e.rotation = l.rotation), null != l.scale && (u.scale = e.scale = l.scale), u
											},
										...
										l.prototype = {
											...
											updateDisplayList: function(t) {
												...
												for (var e = this._roots, i = this._displayList, r = 0, a = e.length; r < a; r++) this._updateAndAddDisplayable(
													e[r], null, t);
											...
											addRoot: function(t) {
												this._elements[t.id] || (t instanceof a && t.addChildrenToStorage(this), this.addToMap(t), this._roots
													.push(t))
											},
											delRoot: function(t) {
												if (null == t) {
												...
												if (t instanceof Array)
													...
													s >= 0 && (this.delFromMap(o.id), this._roots.splice(s, 1), o instanceof a && o.delChildrenFromStorage(
														this))
												}
											},
											addToMap: function(t) {
										...
										s.prototype = {
											...
											_update: function() {
												for (var t = (new Date).getTime() - this._pausedTime, e = t - this._time, i = this._clips, n = i.length,
														r = [], o = [], a = 0; a < n; a++) {
													var s = i[a],
														l = s.step(t);
													l && (r.push(l), o.push(s))
										...
										function n(t) {
											this._target = t.target, this._life = t.life || 1e3, this._delay = t.delay || 0, this._initialized = !1,
												...
												t.onframe, this.ondestroy = t.ondestroy, this.onrestart = t.onrestart
										}
										var r = i(146);
										n.prototype = {
											constructor: n,
											step: function(t) {
												...
												if (!(e < 0)) {
													...
													return this.fire("frame", o), 1 == e ? this.loop ? (this.restart(t), "restart") : (this._needsRemove = !
														0, "destroy") : null
												}
											},
											restart: function(t) {
										...
										var i = {
											...
											elasticIn: function(t) {
												var e, i = .1,
													n = .4;
												return 0 === t ? 0 : 1 === t ? 1 : (!i || i < 1 ? (i = 1, e = n / 4) : e = n * Math.asin(1 / i) / (2 *
													Math.PI), -(i * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / n)))
											},
											elasticOut: function(t) {
												var e, i = .1,
													n = .4;
												return 0 === t ? 0 : 1 === t ? 1 : (!i || i < 1 ? (i = 1, e = n / 4) : e = n * Math.asin(1 / i) / (2 *
													Math.PI), i * Math.pow(2, -10 * t) * Math.sin((t - e) * (2 * Math.PI) / n) + 1)
											},
											elasticInOut: function(t) {
												var e, i = .1,
													n = .4;
												return 0 === t ? 0 : 1 === t ? 1 : (!i || i < 1 ? (i = 1, e = n / 4) : e = n * Math.asin(1 / i) / (2 *
													Math.PI), (t *= 2) < 1 ? -.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) /
													n)) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / n) * .5 + 1)
											},
											backIn: function(t) {
												var e = 1.70158;
												return t * t * ((e + 1) * t - e)
										...
										t.exports = {
											containStroke: function(t, e, i, r, o, a, s, l, h, u, c) {
												...
												if (c > e + d && c > r + d && c > a + d && c > l + d || c < e - d && c < r - d && c < a - d && c < l -
													d || u > t + d && u > i + d && u > o + d && u > s + d || u < t - d && u < i - d && u < o - d && u < s -
													d) return !1;
										...
										function o(t, e, i, n, o, a, s, l, h, u) {
											...
											for (var d, f, p = 0, m = -1, v = 0; v < c; v++) {
												var y = _[v],
													x = 0 === y || 1 === y ? .5 : 1,
													w = g.cubicAt(t, i, o, s, y);
												w < h || (m < 0 && (m = g.cubicExtrema(e, n, a, l, b), b[1] < b[0] && m > 1 && r(), d = g.cubicAt(e, n,
														a, l, b[0]), m > 1 && (f = g.cubicAt(e, n, a, l, b[1]))), p += 2 == m ? y < b[0] ? d < e ? x : -x : y <
											...
											if (h >= 0 && h <= 1) {
												for (var u = 0, c = g.quadraticAt(e, n, o, h), d = 0; d < l; d++) {
													var f = 0 === _[d] || 1 === _[d] ? .5 : 1,
														p = g.quadraticAt(t, i, r, _[d]);
													p < a || (u += _[d] < h ? c < e ? f : -f : o < c ? f : -f)
												}
												return u
											}
											var f = 0 === _[0] || 1 === _[0] ? .5 : 1,
												p = g.quadraticAt(t, i, r, _[0]);
											...
											for (var c = 0, d = 0; d < 2; d++) {
												...
												if (f + t > a) {
													var g = Math.atan2(s, f),
														u = o ? 1 : -1;
													g < 0 && (g = y + g), (g >= n && g <= r || g + y >= n && g + y <= r) && (g > Math.PI / 2 && g < 1.5 *
														Math.PI && (u = -u), c += u)
												}
											}
											return c
										...
										function l(t, e, i, r, l) {
											for (var u = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
												var b = t[_++];
												switch (b === h.M && _ > 1 && (i || (u += m(p, g, y, x, r, l))), 1 == _ && (p = t[_], g = t[_ + 1], y =
													p, x = g), b) {
													case h.M:
														y = t[_++], x = t[_++], p = y, g = x;
														break;
													...
													case h.R:
														...
														var D = t[_++],
															...
															L = x + O;
														if (i) {
															if (v(y, x, k, x, e, r, l) || v(k, x, k, L, e, r, l) || v(k, L, y, L, e, r, l) || v(y, L, y, x, e, r,
																	l)) return !0
										...
										t.exports = n.extend({
											...
											beforeBrush: function() {
												...
												for (var t = this.shape.paths || [], e = this.getGlobalScale(), i = 0; i < t.length; i++) t[i].path.setScale(
													e[0], e[1])
											},
											buildPath: function(t, e) {
										...
										var n = i(1),
											...
											o = function(t, e, i, n, o) {
												this.x = null == t ? .5 : t, this.y = null == e ? .5 : e, this.r = null == i ? .5 : i, this.type =
													"radial", this.global = o || !1, r.call(this, n)
											};
										o.prototype = {
											constructor: o
										}, n.inherits(o, r), t.exports = o
										...
										t.exports = {
											buildPath: function(t, e) {
												var i, n, r, o, a = e.x,
													...
													h = e.height,
													u = e.r;
												l < 0 && (a += l, l = -l), h < 0 && (s += h, h = -h), "number" == typeof u ? i = n = r = o = u : u instanceof Array ?
													1 === u.length ? i = n = r = o = u[0] : 2 === u.length ? (i = r = u[0], n = o = u[1]) : 3 === u.length ?
													(i = u[0], n = o = u[1], r = u[2]) : (i = u[0], n = u[1], r = u[2], o = u[3]) : i = n = r = o = 0;
												var c;
												i + n > l && (c = i + n, i *= l / c, n *= l / c), r + o > l && (c = r + o, r *= l / c, o *= l / c), n +
													r > h && (c = n + r, n *= h / c, r *= h / c), i + o > h && (c = i + o, i *= h / c, o *= h / c), t.moveTo(
														a + i, s), t.lineTo(a + l - n, s), 0 !== n && t.quadraticCurveTo(a + l, s, a + l, s + n), t.lineTo(a +
														l, s + h - r), 0 !== r && t.quadraticCurveTo(a + l, s + h, a + l - r, s + h), t.lineTo(a + o, s + h),
													0 !== o && t.quadraticCurveTo(a, s + h, a, s + h - o), t.lineTo(a, s + i), 0 !== i && t.quadraticCurveTo(
														a, s, a + i, s)
											}
										}
									}, function(t, e, i) {
										...
										t.exports = function(t, e) {
											...
											for (var s = 0; s < l; s++) {
												var h, u, c, d = s / (l - 1) * (e ? i : i - 1),
													...
													p = d - f,
													g = t[f % i];
												e ? (h = t[(f - 1 + i) % i], u = t[(f + 1) % i], c = t[(f + 2) % i]) : (h = t[0 === f ? f : f - 1], u =
													t[f > i - 2 ? i - 1 : f + 1], c = t[f > i - 3 ? i - 1 : f + 2]);
												var m = p * p,
													v = p * m;
										...
										function n(t, e, i) {
											var n = t.cpx2,
												r = t.cpy2;
											return null === n || null === r ? [(i ? c : h)(t.x1, t.cpx1, t.cpx2, t.x2, e), (i ? c : h)(t.y1, t.cpy1,
												t.cpy2, t.y2, e)] : [(i ? u : l)(t.x1, t.cpx1, t.x2, e), (i ? u : l)(t.y1, t.cpy1, t.y2, e)]
										}
										var r = i(18),
											o = i(5),
										...
										t.exports = i(7).extend({
											...
											buildPath: function(t, e) {
												var i = e.x1,
													...
													c = e.cpy2,
													f = e.percent;
												0 !== f && (t.moveTo(i, n), null == u || null == c ? (f < 1 && (a(i, l, r, f, d), l = d[1], r = d[2],
													a(n, h, o, f, d), h = d[1], o = d[2]), t.quadraticCurveTo(l, h, r, o)) : (f < 1 && (s(i, l, u, r,
													f, d), l = d[1], u = d[2], r = d[3], s(n, h, c, o, f, d), h = d[1], c = d[2], o = d[3]), t.bezierCurveTo(
													l, h, u, c, r, o)))
											},
											pointAt: function(t) {
										...
										t.exports = i(7).extend({
											...
											buildPath: function(t, e) {
												var i = e.x1,
													...
													o = e.y2,
													a = e.percent;
												0 !== a && (t.moveTo(i, n), a < 1 && (r = i * (1 - a) + r * a, o = n * (1 - a) + o * a), t.lineTo(r,
													o))
											},
											pointAt: function(t) {
												var e = this.shape;
										...
										t.exports = r.extend({
											...
											brush: n.browser.ie && n.browser.version >= 11 ? function() {
												...
												if (r.prototype.brush.apply(this, arguments), t)
													for (var s = 0; s < o.length; s++) i[o[s][0]] = o[s][2]
											} : r.prototype.brush,
											buildPath: function(t, e) {
												var i = e.cx,
													n = e.cy,
													...
													h = Math.cos(a),
													u = Math.sin(a);
												t.moveTo(h * r + i, u * r + n), t.lineTo(h * o + i, u * o + n), t.arc(i, n, o, a, s, !l), t.lineTo(
													Math.cos(s) * r + i, Math.sin(s) * r + n), 0 !== r && t.arc(i, n, r, s, a, l), t.closePath()
											}
										})
									}, function(t, e, i) {
										"use strict";
										...
										h.prototype = {
											...
											animateTo: function(t, e, i, n, r) {
												...
												o(i) ? (r = n, n = i, i = 0) : a(n) ? (r = n, n = "linear", i = 0) : a(i) ? (r = i, i = 0) : a(e) ? (r =
													e, e = 500) : e || (e = 500), this.stopAnimation(), this._animateToShallow("", this, t, e, i, n, r);
											...
											_animateToShallow: function(t, e, i, n, o) {
												...
												for (var h in i)
													if (i.hasOwnProperty(h))
														if (null != e[h]) s(i[h]) && !r.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h],
															i[h], n, o) : (a[h] = i[h], l++);
														else if (null != i[h])
													if (t) {
														var u = {};
										...
										i.prototype = {
											...
											_dragStart: function(t) {
												...
												e && e.draggable && (this._draggingTarget = e, e.dragging = !0, this._x = t.offsetX, this._y = t.offsetY,
													this.dispatchToElement(e, "dragstart", t.event))
											},
											_drag: function(t) {
												...
												if (e) {
													...
													var a = this.findHover(i, n, e),
														s = this._dropTarget;
													this._dropTarget = a, e !== a && (s && a !== s && this.dispatchToElement(s, "dragleave", t.event), a &&
														a !== s && this.dispatchToElement(a, "dragenter", t.event))
												}
											},
											_dragEnd: function(t) {
												var e = this._draggingTarget;
												e && (e.dragging = !1), this.dispatchToElement(e, "dragend", t.event), this._dropTarget && this.dispatchToElement(
													this._dropTarget, "drop", t.event), this._draggingTarget = null, this._dropTarget = null
											}
										}, t.exports = i
									}, function(t, e, i) {
										function n(t, e, i, n, r, o, a, s, l, h, u) {
											var g = l * (p / 180),
												...
												_ = y * y / (a * a) + x * x / (s * s);
											_ > 1 && (a *= c(_), s *= c(_));
											var b = (r === o ? -1 : 1) * c((a * a * (s * s) - a * a * (x * x) - s * s * (y * y)) / (a * a * (x * x) +
													s * s * (y * y))) || 0,
												w = b * a * x / s,
												M = b * -s * y / a,
												S = (t + i) / 2 + f(g) * w - d(g) * M,
												...
												C = [(-1 * y - w) / a, (-1 * x - M) / s],
												k = v(I, C);
											m(I, C) <= -1 && (k = p), m(I, C) >= 1 && (k = 0), 0 === o && k > 0 && (k -= 2 * p), 1 === o && k < 0 &&
												(k += 2 * p), u.addData(h, S, T, a, s, A, k, g, o)
										}
											...
											for (o = 0, u = 0; o < f.length;) {
												switch (i = f[o++], u = o, n = 0, i) {
													...
													case y:
														...
														break;
													case v:
														d[0] = f[o++], d[1] = f[o++], a(d, d, e), f[u++] = d[0], f[u++] = d[1], d[0] += f[o++], d[1] += f[o++],
															a(d, d, e), f[u++] = d[0], f[u++] = d[1]
												}
												for (c = 0; c < n; c++) {
													var d = s[c];
										...
										d.nextTick = function(t) {
											...
											h, d.addListener = h, d.once = h, d.off = h, d.removeListener = h, d.removeAllListeners = h, d.emit = h,
										...
										var n = i(1),
											r = i(2);
										i(179), i(180), r.registerVisual(n.curry(i(45), "scatter", "circle", null)), r.registerLayout(n.curry(i(56),
											"scatter")), i(31)
									}, function(t, e, i) {
										"use strict";
										var n = i(35),
										...
										function r(t, e) {
											...
											var n = e.getMax(!0);
											return null != n && "dataMax" !== n && (t[1] = n), e.get("scale", !0) || (t[0] > 0 && (t[0] = 0), t[1] <
												0 && (t[1] = 0)), t
										}
										...
										function o(t, e) {
											var i = t.getAxisModel(),
												...
												r = t._valueWindow;
											if (n) {
												var o = s.getPixelPrecision(r, [0, 500]),
													a = e || 0 === n[0] && 100 === n[1];
										...
										var a = i(1),
											...
											u = s.asc,
											c = function(t, e, i, n) {
												this._dimName = t, this._axisIndex = e, this._valueWindow, this._percentWindow, this._dataExtent, this.ecModel =
													n, this._dataZoomModel = i
											};
										c.prototype = {
											constructor: c,
											hostedBy: function(t) {
											...
											getOtherAxisModel: function() {
												var t, e, i = this._dimName,
													...
													r = this.getAxisModel(),
													o = "x" === i || "y" === i;
												o ? (e = "gridIndex", t = "x" === i ? "y" : "x") : (e = "polarIndex", t = "angle" === i ? "radius" :
													"angle");
												var a;
											...
											calculateDataWindow: function(t) {
												...
												return e = e.slice(), r(e, i), h(["startValue", "endValue"], function(e) {
													...
													var i = l[t],
														r = a[t];
													null != r || null == i ? (null == r && (r = o[t]), i = n.parse(s.linearMap(r, o, e, !0))) : r = s.linearMap(
														i, e, o, !0), l[t] = i, a[t] = r
												}), {
													valueWindow: u(l),
													percentWindow: u(a)
										...
										function n(t) {
											var e = [0, 100];
											return !(t[0] <= e[1]) && (t[0] = e[1]), !(t[1] <= e[1]) && (t[1] = e[1]), !(t[0] >= e[0]) && (t[0] = e[0]),
												!(t[1] >= e[0]) && (t[1] = e[0]),
												t
										}
										var r = i(41),
											...
											h = r.extend({
												...
												render: function(t, e, i, n) {
													h.superApply(this, "render", arguments), s.shouldRecordRange(n, t.id) && (this._range = t.getPercentRange()),
														o.each(this.getTargetCoordInfo(), function(e, n) {
												...
												dispose: function() {
													s.unregister(this.api, this.dataZoomModel.id), h.superApply(this, "dispose", arguments), this._range =
														null
												},
												...
												_onZoom: function(t, e, i, r, o, a) {
													...
													if (h) {
														...
														return r = Math.max(1 / r, 0), l[0] = (l[0] - d) * r + d, l[1] = (l[1] - d) * r + d, this._range = n(
															l)
													}
												}
											}),
											u = {
												...
												polar: function(t, e, i, n, r) {
													...
													return t = t ? s.pointToCoord(t) : [0, 0], e = s.pointToCoord(e), "radiusAxis" === i.mainType ? (a.pixel =
														e[0] - t[0], a.pixelLength = l[1] - l[0], a.pixelStart = l[0], a.signal = o.inverse ? 1 : -1) : (a.pixel =
														e[1] - t[1], a.pixelLength = h[1] - h[0], a.pixelStart = h[0], a.signal = o.inverse ? -1 : 1), a
												},
										...
										var r = i(1),
											...
											M = s.extend({
												...
												render: function(t, e, i, n) {
													return M.superApply(this, "render", arguments), a.createOrUpdate(this, "_dispatchZoomAction", this.dataZoomModel
															.get("throttle"), "fixRate"), this._orient = t.get("orient"), this.dataZoomModel.get("show") === !1 ?
														void this.group.removeAll() : (n && "dataZoom" === n.type && n.from === this.uid || this._buildView(),
														...
														if (null != a) {
															...
															n.each([a], function(t, e) {
																...
																var i = null == t || isNaN(t) || "" === t,
																	n = i ? 0 : u(t, s, c, !0);
																i && !h && e ? (f.push([f[f.length - 1][0], 0]), p.push([p[p.length - 1][0], 0])) : !i && h && (
																	f.push([m, 0]), p.push([m, 0])), f.push([m, n]), p.push([m, n]), m += g, h = i
															});
														...
														return t.eachTargetAxis(function(a, s) {
															...
															r.each(l, function(t) {
																if (!(i || e !== !0 && r.indexOf(w, t.get("type")) < 0)) {
																	var l, h = o.getComponent(a.axis, s).axis,
																		u = n(a.name),
																		c = t.coordinateSystem;
												...
												_renderHandle: function() {
													...
													g([0, 1], function(t) {
														var r = o.makePath(s, {
															...
															l = r.getBoundingRect();
														this._handleHeight = h.parsePercent(a.get("handleSize"), this._size[1]), this._handleWidth = l.width /
															l.height * this._handleHeight, r.setStyle(a.getModel("handleStyle").getItemStyle());
												...
												_updateInterval: function(t, e) {
													...
													d(e, i, n, "all" === t || this.dataZoomModel.get("zoomLock") ? "rigid" : "cross", t), this._range = f(
														[u(i[0], n, [0, 100], !0), u(i[1], n, [0, 100], !0)])
												},
											...
											g = {
												register: function(t, e) {
													...
													l || (l = i[s] = {
															...
															dataZoomInfos: {},
															count: 0
														}, l.controller = r(t, e, l), l.dispatchAction = u.curry(h, t)), l.controller.setContainsPoint(e.containsPoint),
														d.createOrUpdate(l, "dispatchAction", e.throttleRate, "fixRate"), !l.dataZoomInfos[a] && l.count++, l
														.dataZoomInfos[a] = e
												},
										...
										function n(t, e, i, n) {
											var r = i.type,
												o = u[r.charAt(0).toUpperCase() + r.slice(1)],
												a = new o(i);
										...
										function o(t) {
											return t = l.extend({}, t), l.each(["id", "parentId", "$action", "hv", "bounding"].concat(c.LOCATION_PARAMS),
												function(e) {
													delete t[e]
												}), t
										}
												...
												l.each(s, function(t, e) {
													...
													if (n) {
														...
														var o = n.parentId,
															s = n.parentOption,
															h = i && i.parentId;
														!n.type && i && (n.type = i.type), n.parentId = o ? o : s ? s.id : h ? h : null, n.parentOption =
															null, u.push(n);
														var d = l.extend({}, n),
															f = n.$action;
														if (f && "merge" !== f) "replace" === f ? r[e] = d : "remove" === f && i && (r[e] = null);
														else if (i) {
															l.merge(i, d, !0), c.mergeLayoutParam(i, d, {
																ignoreSize: !0
															}), c.copyLayoutParams(n, i)
														} else r[e] = d;
														r[e] && (r[e].hv = n.hv = [a(n, ["left", "right"]), a(n, ["top", "bottom"])], "group" === r[e].type &&
															(null == r[e].width && (r[e].width = n.width = 0), null == r[e].height && (r[e].height = n.height =
																0)))
													}
												}, this);
											...
											_updateElements: function(t, e) {
												...
												if (i) {
													...
													l.each(i, function(t) {
														...
														var d = o(t);
														e && "merge" !== e ? "replace" === e ? (r(h, a), n(i, c, d, a)) : "remove" === e && r(h, a) : h ?
															h.attr(d) : n(i, c, d, a), a[i] && (a[i].__ecGraphicWidth = t.width, a[i].__ecGraphicHeight = t.height)
													})
												}
											},
													...
													a.each(t.getData(), function(a) {
														...
														if (!f[h])
															if (p) {
																...
																x.on("click", u(n, h, i)).on("mouseover", u(r, p, null, i)).on("mouseout", u(o, p, null, i)), f[
																	h] = !0
																...
																if (!f[h] && e.legendDataProvider) {
																	...
																	m.on("click", u(n, h, i)).on("mouseover", u(r, e, h, i)).on("mouseout", u(o, e, h, i)), f[h] = !
																		0
																}
															}, this)
										...
										var r = i(2),
											o = i(1);
										r.registerAction("legendToggleSelect", "legendselectchanged", o.curry(n, "toggleSelected")), r.registerAction(
											"legendSelect", "legendselected", o.curry(n, "select")), r.registerAction("legendUnSelect",
											"legendunselected", o.curry(n, "unSelect"))
									}, function(t, e) {
										t.exports = function(t) {
										...
										function a(t, e, i, r, o) {
											var a, s = r.coordinateSystem,
												l = t.getItemModel(e),
												h = u.parsePercent(l.get(i[0]), o.getWidth()),
												c = u.parsePercent(l.get(i[1]), o.getHeight());
											if (isNaN(h) || isNaN(c)) {
												if (r.getMarkerPosition) a = r.getMarkerPosition(t.getValues(i, e));
												else {
													var d = t.get(i[0], e),
														f = t.get(i[1], e);
												...
												if ("cartesian2d" === s.type) {
													var p = s.getAxis("x"),
														...
														d = t.get(i[0], e),
														f = t.get(i[1], e);
													n(d) ? a[0] = p.toGlobalCoord(p.getExtent()["x0" === i[0] ? 0 : 1]) : n(f) && (a[1] = g.toGlobalCoord(g
														.getExtent()["y0" === i[1] ? 0 : 1]))
												}
										...
										i(71).extend({
											...
											renderSeries: function(t, e, i, n) {
												...
												e.setData(p), p.each(function(e) {
													...
													var s = p.getName(i) || "",
														h = a || t.style.fill;
													r.getShallow("show") ? (c.setText(t.style, r, h), t.style.text = l.retrieve(e.getFormattedLabel(i,
														"normal"), s)) : t.style.text = "", o.getShallow("show") ? (c.setText(t.hoverStyle, o, h), t.hoverStyle
														.text = l.retrieve(e.getFormattedLabel(i, "emphasis"), s)) : t.hoverStyle.text = "", c.setHoverStyle(
														t, {}), t.dataModel = e
										...
										function a(t, e, i, r, o) {
											var a, s = r.coordinateSystem,
												l = t.getItemModel(e),
												h = u.parsePercent(l.get("x"), o.getWidth()),
											...
											if (isNaN(h) || isNaN(c)) {
												...
												if ("cartesian2d" === s.type) {
													var g = s.getAxis("x"),
														m = s.getAxis("y"),
														d = s.dimensions;
													n(t.get(d[0], e)) ? a[0] = g.toGlobalCoord(g.getExtent()[i ? 0 : 1]) : n(t.get(d[1], e)) && (a[1] = m.toGlobalCoord(
														m.getExtent()[i ? 0 : 1]))
												}
												isNaN(h) || (a[0] = h), isNaN(c) || (a[1] = c)
											} else a = [h, c];
										...
										function s(t, e, i) {
											...
											var r = new h(n, i),
												a = new h(n, i),
												s = new h([], i),
												u = l.map(i.get("data"), l.curry(f, e, t, i));
										...
										var l = i(1),
											...
											f = function(t, e, i, n) {
												...
												if (!l.isArray(n) && ("min" === o || "max" === o || "average" === o || null != n.xAxis || null != n.yAxis)) {
													var a, s, h;
													if (null != n.yAxis || null != n.xAxis) s = null != n.yAxis ? "y" : "x", a = e.getAxis(s), h = l.retrieve(
														n.yAxis, n.xAxis);
													else {
												...
												return n = [c.dataTransform(t, n[0]), c.dataTransform(t, n[1]), l.extend({}, n[2])], n[2].type = n[2].type ||
													"", l.merge(n[2], n[0]), l.merge(n[2], n[1]), n
											};
										i(71).extend({
											type: "markLine",
											updateLayout: function(t, e, i) {
										...
										function r(t, e, i) {
											...
											var r = new l(n, i),
												o = a.map(i.get("data"), a.curry(h.dataTransform, e));
											return t && (o = a.filter(o, a.curry(h.dataFilter, t))), r.initData(o, null, t ? h.dimValueGetter :
												function(t) {
													return t.value
												}), r
										}
											...
											render: function(t, e, i) {
												if (this.group.removeAll(), t.get("show")) {
													...
													l || (l = t.get("left") || t.get("right"), "middle" === l && (l = "center"), "right" === l ? y.x +=
														y.width : "center" === l && (y.x += y.width / 2)), h || (h = t.get("top") || t.get("bottom"),
														"center" === h && (h = "middle"), "bottom" === h ? y.y += y.height : "middle" === h && (y.y += y.height /
															2), h = h || "top"), n.attr("position", [y.x, y.y]);
													var x = {
														textAlign: l,
														textVerticalAlign: h
													};
											...
											t.exports = i(2).extendComponentView({
												...
												render: function(t, e, i, c) {
													function d(o, a) {
														...
														return !h && u ? void(l.dispose && l.dispose(e, i)) : !p.get("show") || l.unusable ? void(l.remove &&
															l.remove(e, i)) : (f(p, l, h), p.setIconStatus = function(t, e) {
															var i = this.option,
																n = this.iconPaths;
													...
													function f(n, r, s) {
														...
														o.each(h, function(s, h) {
															...
															})), v.trigger(n.get("iconStatus." + h) || "normal"), p.add(v), v.on("click", o.bind(r.onclick,
																r, e, i, h)), f[h] = v
														})
													}
													var p = this.group;
													if (p.removeAll(), t.get("show")) {
														...
														o.each(m, function(t, e) {
															...
															y, h.layout(p, t, i), h.addBackground(p, t), p.eachChild(function(t) {
																var e = t.__title,
																	n = t.hoverStyle;
																if (n && e) {
																	...
																	o + r.width / 2 > i.getWidth() ? (n.textPosition = ["100%", l], n.textAlign = "right") : o - r
																		.width / 2 < 0 && (n.textPosition = [0, l], n.textAlign = "left")
																}
															})
													}
												},
										...
										function o(t) {
											return p.map(t, function(t) {
												...
												return e.each(e.dimensions, function() {
													for (var t = arguments.length, r = arguments[t - 1], o = e.getName(r), a = 0; a < t - 1; a++) n[a] =
														arguments[a];
										...
										d.defaultOption = {
											...
											} else h.appendChild(u), u.readOnly = r.get("readOnly"), u.style.cssText =
												"width:100%;height:100%;font-family:monospace;font-size:14px;line-height:1.6rem;", u.style.color = r.get(
													"textColor"), u.style.borderColor = r.get("textareaBorderColor"), u.style.backgroundColor = r.get(
													"textareaColor"), u.value = m.value;
											var x = m.meta,
											...
											g.addEventListener(w, "click", i), g.addEventListener(M, "click", function() {
												...
												_.appendChild(M), _.appendChild(w), g.addEventListener(u, "keydown", function(t) {
													if (9 === (t.keyCode || t.which)) {
														var e = this.value,
															i = this.selectionStart,
															n = this.selectionEnd;
														this.value = e.substring(0, i) + v + e.substring(n), this.selectionStart = this.selectionEnd = i + 1,
															g.stop(t)
													}
												}), o.appendChild(s), o.appendChild(h), o.appendChild(_), h.style.height = n.clientHeight - 80 + "px",
										...
										function a(t, e, i, n) {
											...
											n && "takeGlobalCursor" === n.type && (o = "dataZoomSelect" === n.key && n.dataZoomSelectActive), i._isZoomActive =
												o, t.setIconStatus("zoom", o ? "emphasis" : "normal");
										...
										f._onBrush = function(t, e) {
											...
											if (e.isEnd && t.length) {
												...
												var s = h.makeCoordInfoList(r(this.model.option), a),
													l = [];
											...
											function e(t, e) {
												if (e) {
													var r = t + "Index",
														o = e[r];
													null == o || "all" == o || s.isArray(o) || (o = o === !1 || "none" === o ? [] : [o]), i(t, function(e,
														i) {
										...
										o.onclick = function(t, e) {
											...
											if (o.href = s, "function" != typeof MouseEvent || r.browser.ie || r.browser.edge) {
												var l = i.get("lang"),
													h = '<body style="margin:0;"><img src="' + s + '" style="max-width:100%;" title="' + (l && l[0] || "") +
													'" /></body>',
													u = window.open();
												u.document.write(h)
											} else {
										...
										function r(t) {
											var e = [],
												i = t.get("fontSize"),
												n = t.getTextColor();
											return n && e.push("color:" + n), e.push("font:" + t.getFont()), i && e.push("line-height:" + Math.round(
												3 * i / 2) + "px"), c(["decoration", "align"], function(i) {
												var n = t.get(i);
												n && e.push("text-" + i + ":" + n)
											}), e.join(";")
										}
										...
										function o(t) {
											...
											var e = [],
												...
												a = t.getModel("textStyle"),
												s = t.get("padding");
											return i && e.push(n(i)), o && (f.canvasSupported ? e.push("background-Color:" + o) : (e.push(
										...
										function a(t, e) {
											var i = document.createElement("div"),
												n = e.getZr();
											this.el = i, this._x = e.getWidth() / 2, this._y = e.getHeight() / 2, t.appendChild(i), this._container =
										...
										a.prototype = {
											...
											hideLater: function(t) {
												!this._show || this._inContent && this.enterable || (t ? (this._hideDelay = t, this._show = !1, this._hideTimeout =
										...
										function l(t, e, i, n, r) {
											var o = i.clientWidth,
												a = i.clientHeight;
											return t = Math.min(t + o, n) - o, e = Math.min(e + a, r) - a, t = Math.max(t, 0), e = Math.max(e, 0), [t,
												e
											]
										}
										...
										function u(t, e, i, n, r, o, a, u) {
											...
											if (a && f.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], o, r.el, f)), p.isArray(
													t)) e = y(t[0], c), i = y(t[1], d);
										...
										i(2).extendComponentView({
											...
											render: function(t, e, i) {
												if (!x.node) {
													this.group.removeAll(), this._axisPointers = {}, this._tooltipModel = t, this._ecModel = e, this._api =
														i, this._lastHover = {};
													var n = this._tooltipContent;
													n.update(), n.enterable = t.get("enterable"), this._alwaysShowContent = t.get("alwaysShowContent"),
													...
													s.off("click", this._tryShow), s.off("mousemove", this._mousemove), s.off("mouseout", this._hide), s
														.off("globalout", this._hide), "click" === o ? s.on("click", this._tryShow, this) : "mousemove" ===
														o && (s.on("mousemove", this._mousemove, this), s.on("mouseout", this._hide, this), s.on(
															"globalout", this._hide, this))
												}
											},
												...
												if (n.from !== this.uid) {
													...
													if (null == n.x || null == n.y) {
														if (s ? (a && !r(a) && (a = null), a || e.eachSeries(function(t) {
															...
															var l = a.getData(),
																h = v.queryDataIndex(l, n);
															if (null == h || p.isArray(h)) return;
															var u, d, f = l.getItemGraphicEl(h),
																g = a.coordinateSystem;
											...
											_prepareAxisTriggerData: function(t, e) {
												...
												return e.eachSeries(function(t) {
													if (c(t)) {
														...
														"cartesian2d" === r.type ? (e = r.getBaseAxis(), n = e.dim + e.index) : "singleAxis" === r.type ?
															(e = r.getAxis(), n = e.dim + e.type) : (e = r.getBaseAxis(), n = e.dim + r.name), i[n] = i[n] ||
															{
																coordSys: [],
																series: []
												...
												if (i)
													if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
														var a = e.dataModel || r.getSeriesByIndex(e.seriesIndex),
															...
															l = a.getData(),
															h = l.getItemModel(s);
														"axis" === (h.get("tooltip.trigger") || n) ? this._showAxisTooltip(i, r, t): (this._ticket = "",
															this._hideAxisPointer(), this._resetLastHover(), this._showItemTooltipContent(a, s, e.dataType, t)
														), o.dispatchAction({
															type: "showTip",
															from: this.uid,
															dataIndexInside: s,
													...
													var d = new _(u, i),
														f = d.get("content"),
														p = Math.random();
													this._showTooltipContent(d, f, d.get("formatterParams") || {}, p, t.offsetX, t.offsetY, t.position,
														e, o)
												} else "item" === n ? this._hide() : this._showAxisTooltip(i, r, t), "cross" === i.get(
													"axisPointer.type") && o.dispatchAction({
													type: "showTip",
													from: this.uid,
													x: t.offsetX,
													y: t.offsetY
											...
											_showAxisTooltip: function(t, e, i) {
												...
												p.each(this._seriesGroupByAxis, function(e) {
													...
													var d = s.getBaseAxis(),
														f = r.get("axis");
													if ("auto" === f && (f = d.dim), d.isBlank() || p.eqNaN(l[0]) || p.eqNaN(l[1])) return void this._hideAxisPointer(
														s.name);
													var g = !1,
														m = this._lastHover;
													if ("cross" === o) n(m.data, c) && (g = !0), m.data = c;
													else {
														var v = p.indexOf(u, f);
														m.data === c[v] && (g = !0), m.data = c[v]
													}
													var y = t.get("animation");
													"cartesian2d" !== s.type || g ? "polar" !== s.type || g ? "singleAxis" !== s.type || g || this._showSinglePointer(
														r, s, f, l, y) : this._showPolarPointer(r, s, f, l, y) : this._showCartesianPointer(r, s, f, l,
														y), "cross" !== o && this._dispatchAndShowSeriesTooltipContent(s, e.series, l, c, g, i.position)
											...
											_showCartesianPointer: function(t, e, i, n, a) {
												...
												if ("cross" === u) s("x", n, e.getAxis("y").getGlobalExtent()), s("y", n, e.getAxis("x").getGlobalExtent()),
											...
											_showSinglePointer: function(t, e, i, n, o) {
												...
												var s = this,
													l = t.get("type"),
													h = o && "cross" !== l && "category" === e.getBaseAxis().type,
													u = e.getRect(),
													c = [u.y, u.y + u.height];
												a(i, n, c)
											},
											_showPolarPointer: function(t, e, i, n, o) {
												...
												function l(i, n, r) {
													var o, s = e.getAxis(i),
														...
														u = e.pointToCoord(n),
														c = Math.PI / 180;
													o = "angle" === i ? a(e.cx, e.cy, r[0], r[1], (-u[1] - l / 2) * c, (-u[1] + l / 2) * c) : a(e.cx, e.cy,
														u[0] - l / 2, u[0] + l / 2, 0, 2 * Math.PI);
												...
												if ("cross" === u) s("angle", n, d.getExtent()), s("radius", n, c.getExtent()), this._updateCrossText(
													e, n, t);
												else {
											...
											_updateCrossText: function(t, e, i) {
												...
												s = p.map(s, function(e, i) {
													var n = t.getAxis(l[i]);
													return e = "category" === n.type || "time" === n.type ? n.scale.getLabel(e) : g.addCommas(e.toFixed(
														n.getPixelPrecision()))
												}), a.setStyle({
											...
											_dispatchAndShowSeriesTooltipContent: function(t, e, i, n, r, o) {
												...
												if (e.length) {
													var h, c = p.map(e, function(t) {
														return {
															seriesIndex: t.seriesIndex,
															dataIndexInside: t.getAxisTooltipDataIndex ? t.getAxisTooltipDataIndex(t.coordDimToDataDim(s.dim),
																n, s) : t.getData().indexOfNearest(t.coordDimToDataDim(s.dim)[0], n[l], !1, "category" === s.type ?
																.5 : null)
														}
													});
													...
													if (f.dispatchAction({
														...
														if (r) u(o || a.get("position"), i[0], i[1], a.get("confine"), this._tooltipContent, v, null, f);
														else {
											...
											_showItemTooltipContent: function(t, e, i, n) {
												...
												var h = this._tooltipModel,
													u = t.getModel("tooltip", h),
													c = new _(s, u, u.ecModel),
											...
											_showTooltipContent: function(t, e, i, n, r, o, a, s, l) {
												if (this._ticket = "", t.get("showContent") && t.get("show")) {
													...
													var f = e;
													if (d)
														if ("string" == typeof d) f = g.formatTpl(d, i, !0);
											...
											_hide: function() {
												clearTimeout(this._showTimeout), this._hideAxisPointer(), this._resetLastHover(), this._alwaysShowContent ||
													this._tooltipContent.hideLater(this._tooltipModel.get("hideDelay")), this._api.dispatchAction({
														type: "hideTip",
														from: this.uid
											...
											dispose: function(t, e) {
												if (!x.node) {
													var i = e.getZr();
													this._tooltipContent.hide(), i.off("click", this._tryShow), i.off("mousemove", this._mousemove), i.off(
														"mouseout", this._hide), i.off("globalout", this._hide)
												}
											}
										})
									}, , function(t, e, i) {
											...
											_paintList: function(t) {
												for (var e = this._vmlRoot, i = 0; i < t.length; i++) {
													...
													n.invisible || n.ignore ? (n.__alreadyNotVisible || n.onRemove(e), n.__alreadyNotVisible = !0) : (n.__alreadyNotVisible &&
														n.onAdd(e), n.__alreadyNotVisible = !1, n.__dirty && (n.beforeBrush && n.beforeBrush(), (n.brushVML ||
															n.brush).call(n, e), n.afterBrush && n.afterBrush())), n.__dirty = !1
												}
										...
										for (var l = ["getLayer", "insertLayer", "eachLayer", "eachBuildinLayer", "eachOtherLayer", "getLayers",
										...
										if (!i(10).canvasSupported) {
											var n = i(5),
												...
												I = 1e3,
												C = function(t) {
													t.style.cssText = "position:absolute;left:0;top:0;width:1px;height:1px;", t.coordsize = S + "," + S, t.coordorigin =
														"0,0"
												},
												k = function(t) {
														...
														if (n instanceof f) {
															...
															if (A >= 2) {
																var D = I[0][0],
																	...
																	z = I[0][1] * e.opacity,
																	R = I[1][1] * e.opacity;
																t.type = r, t.method = "none", t.focus = "100%", t.angle = o, t.color = D, t.color2 = O, t.colors =
																	C.join(","), t.opacity = R, t.opacity2 = z
															}
															"radial" === r && (t.focusposition = a.join(","))
														} else E(t, n, e.opacity)
												},
												B = function(t, e) {
													null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")), null == e.stroke || e.stroke instanceof f ||
														E(t, e.stroke, e.opacity)
												},
												V = function(t, e, i, n) {
													var r = "fill" == e,
														o = t.getElementsByTagName(e)[0];
													null != i[e] && "none" !== i[e] && (r || !r && i.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", i[
														e] instanceof f && D(t, o), o || (o = p.createNode(e)), r ? R(o, i, n) : B(o, i), P(t, o)) : (t[r ?
														"filled" : "stroked"] = "false", D(t, o))
												},
												F = [
													[],
													[],
														...
														switch (r = t[a++], n = "", i = 0, r) {
															...
															case u:
																...
																var v, _, M = t[a++],
																	...
																	I = t[a++],
																	C = t[a++];
																r === f ? (v = I, _ = C, I = (I + 2 * M) / 3, C = (C + 2 * A) / 3, M = (s + 2 * M) / 3, A = (l + 2 *
																		A) / 3) : (v = t[a++], _ = t[a++]), F[0][0] = M, F[0][1] = A, F[1][0] = I, F[1][1] = C, F[2][0] =
																	v, F[2][1] = _, s = v, l = _;
																break;
															case d:
																var k = 0,
																	...
																	D = 1,
																	O = 0;
																e && (k = e[4], L = e[5], P = m(e[0] * e[0] + e[1] * e[1]), D = m(e[2] * e[2] + e[3] * e[3]), O =
																	Math.atan2(-e[1] / D, e[0] / P));
																var z = t[a++],
																	E = t[a++],
																	N = t[a++],
																	R = t[a++],
																...
																var G = t[a++],
																	...
																	A = E + x(V) * R,
																	Z = G ? " wa " : " at ";
																Math.abs(H - M) < 1e-4 && (Math.abs(V - B) > .01 ? G && (H += 270 / S) : Math.abs(W - E) < 1e-4 ? G &&
																	H < z || !G && H > z ? A -= 270 / S : A += 270 / S : G && W < E || !G && W > E ? M += 270 / S : M -=
																	270 / S), p.push(Z, g(((z - N) * P + k) * S - T), w, g(((E - R) * D + L) * S - T), w, g(((z + N) *
																	P + k) * S - T), w, g(((E + R) * D + L) * S - T), w, g((H * P + k) * S - T), w, g((W * D + L) * S -
																	T), w, g((M * P + k) * S - T), w, g((A * D + L) * S - T)), s = M, l = A;
																break;
															case o.R:
																var q = F[0],
																	j = F[1];
																q[0] = t[a++], q[1] = t[a++], j[0] = q[0] + t[a++], j[1] = q[1] + t[a++], e && (b(q, q, e), b(j, j,
																		e)), q[0] = g(q[0] * S - T), j[0] = g(j[0] * S - T), q[1] = g(q[1] * S - T), j[1] = g(j[1] * S - T),
											...
											d.prototype.brushVML = function(t) {
												...
												this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !1),
													i.path = G(l.data, this.transform), i.style.zIndex = O(this.zlevel, this.z, this.z2), P(t, i), null !=
											...
											u.prototype.brushVML = function(t) {
												...
												if (H(r)) {
													...
													if (o === this._imageSrc) e = this._imageWidth, i = this._imageHeight;
														...
														var a = r.runtimeStyle,
															s = a.width,
															l = a.height;
														a.width = "auto", a.height = "auto", e = r.width, i = r.height, a.width = s, a.height = l, this._imageSrc =
															o, this._imageWidth = e, this._imageHeight = i
													}
													r = o
												...
												if (r) {
													...
													var A, I = T.style,
														...
														L = 1,
														D = 1;
													if (this.transform && (A = this.transform, L = m(A[0] * A[0] + A[1] * A[1]), D = m(A[2] * A[2] + A[3] *
															A[3]), k = A[1] || A[2]), k) {
														var z = [h, u],
															E = [h + c, u],
															N = [h, u + d],
														...
														var B = _(z[0], E[0], N[0], R[0]),
															V = _(z[1], E[1], N[1], R[1]),
															F = [];
														F.push("M11=", A[0] / L, w, "M12=", A[2] / D, w, "M21=", A[1] / L, w, "M22=", A[3] / D, w, "Dx=", g(h *
																L + A[4]), w, "Dy=", g(u * D + A[5])), I.padding = "0 " + g(B) + "px " + g(V) + "px 0", I.filter =
															M + ".Matrix(" + F.join("") + ", SizingMethod=clip)"
													} else A && (h = h * L + A[4], u = u * D + A[5]), I.filter = "", I.left = g(h) + "px", I.top = g(u) +
														"px";
													var G = this._imageEl,
														W = this._cropEl;
													...
													var Z = G.style;
													if (S) {
														if (e && i) Z.width = g(L * e * c / f) + "px", Z.height = g(D * i * d / v) + "px";
														else {
															var q = new Image,
																j = this;
															q.onload = function() {
																q.onload = null, e = q.width, i = q.height, Z.width = g(L * e * c / f) + "px", Z.height = g(D * i *
																	d / v) + "px", j._imageWidth = e, j._imageHeight = i, j._imageSrc = r
															}, q.src = r
														}
														W || (W = p.doc.createElement("div"), W.style.overflow = "hidden", this._cropEl = W);
														var U = W.style;
														U.width = g((c + y * c / f) * L), U.height = g((d + x * d / v) * D), U.filter = M + ".Matrix(Dx=" + -
															y * c / f * L + ",Dy=" + -x * d / v * D + ")", W.parentNode || T.appendChild(W), G.parentNode != W &&
															W.appendChild(G)
													} else Z.width = g(L * c) + "px", Z.height = g(D * d) + "px", T.appendChild(G), W && W.parentNode && (
														T.removeChild(W), this._cropEl = null);
													var X = "",
														Y = n.opacity;
													Y < 1 && (X += ".Alpha(opacity=" + g(100 * Y) + ") "), X += M + ".AlphaImageLoader(src=" + r +
														", SizingMethod=scale)", Z.filter = X, T.style.zIndex = O(this.zlevel, this.z, this.z2), P(t, T),
											...
											s.measureText = function(t, e) {
												var i = p.doc;
												W || (W = i.createElement("div"), W.style.cssText =
													"position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;", p.doc.body.appendChild(
														W));
												try {
													W.style.font = e
												} catch (n) {}
													...
													if (null != o && (o += ""), o) {
														...
														if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n) a = e.x, l = e.y;
															...
															var v = r.textPosition,
																y = r.textDistance;
															if (v instanceof Array) a = e.x + z(v[0], e.width), l = e.y + z(v[1], e.height), h = h || "left", d =
																d || "top";
															else {
														...
														var M, S, T, A = p.createNode,
															I = this._textVmlEl;
														I ? (T = I.firstChild, M = T.nextSibling, S = M.nextSibling) : (I = A("line"), M = A("path"), S = A(
																"textpath"), T = A("skew"), S.style["v-text-align"] = "left", C(I), M.textpathok = !0, S.on = !0,
															I.from = "0 0", I.to = "1000 0.05", P(I, T), P(I, M), P(I, S), this._textVmlEl = I);
														var L = [a, l],
															D = I.style;
														m && n ? (b(L, L, m), T.on = !0, T.matrix = m[0].toFixed(3) + w + m[2].toFixed(3) + w + m[1].toFixed(
																	3) + w + m[3].toFixed(3) + ",0,0", T.offset = (g(L[0]) || 0) + "," + (g(L[1]) || 0), T.origin =
																"0 0", D.left = "0px", D.top = "0px") : (T.on = !1, D.left = g(a) + "px", D.top = g(l) + "px"), S.string =
															k(o);
														try {
															S.style.font = c
														} catch (E) {}
